(* Generated merchant_portal_common_controller direct-call test. *)
...
let () =
  test "merchant_portal_common_controller.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/merchant_portal_common_controller"); ("method", Str "GET")]) in
