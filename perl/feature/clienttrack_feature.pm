# BluefinTecsMerchantPortal SDK clienttrack feature
#
...
package BluefinTecsMerchantPortalClienttrackFeature;
...
sub _client_name {
  ...
  my $name = defined $self->{options}{clientName}
    ? $self->{options}{clientName} : 'BluefinTecsMerchantPortal-SDK';
