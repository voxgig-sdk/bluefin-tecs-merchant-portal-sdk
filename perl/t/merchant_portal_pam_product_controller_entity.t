...
BASIC_FLOW: {
  ...
  if ($setup->{synthetic_only}) {
    note('live entity test uses synthetic IDs from fixture - set BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_PRODUCT_CONTROLLER_ENTID JSON to run live');
  ...
  $V{merchant_portal_pam_product_controller_ref01_data} = BluefinTecsMerchantPortalHelpers::to_map(ref($V{merchant_portal_pam_product_controller_ref01_data_result}) && $V{merchant_portal_pam_product_controller_ref01_data_result}->can('data_get') ? $V{merchant_portal_pam_product_controller_ref01_data_result}->data_get : $V{merchant_portal_pam_product_controller_ref01_data_result});
...
sub merchant_portal_pam_product_controller_basic_setup {
  ...
  # skip.
  my $entid_env_raw = $ENV{'BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_PRODUCT_CONTROLLER_ENTID'};
  ...
  my $idmap_resolved = BluefinTecsMerchantPortalHelpers::to_map($env->{'BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_PRODUCT_CONTROLLER_ENTID'});
