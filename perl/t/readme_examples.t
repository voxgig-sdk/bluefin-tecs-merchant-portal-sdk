...
#      (BluefinTecsMerchantPortalSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinTecsMerchantPortalSDK';
...
# becomes BluefinTecsMerchantPortalSDK->test(<fixtures>); a block that only uses $client gets
