# BluefinTecsMerchantPortal SDK utility: transform_response
...
$REGISTRY{transform_response} = sub {
  ...
  my $resform = BluefinTecsMerchantPortalHelpers::gp($transform, 'res');
  return undef unless BluefinTecsMerchantPortalHelpers::rb_truthy($resform);
