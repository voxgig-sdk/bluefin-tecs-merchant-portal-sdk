...
package MerchantPortalPamProductControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_pam_product_controller',
    _client => $client,
...
# Returns the current MerchantPortalPamProductController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalPamProductController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (MerchantPortalPamProductControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalPamProductController data (hashref); dies
