...
package MerchantPortalCommonControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_common_controller',
    _client => $client,
...
# Returns the current MerchantPortalCommonController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalCommonController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqmatch: match criteria hashref (id/query fields; MerchantPortalCommonControllerLoadMatch
...
# Returns the loaded MerchantPortalCommonController data (hashref); dies with BluefinTecsMerchantPortalError
# on failure.
sub load {
