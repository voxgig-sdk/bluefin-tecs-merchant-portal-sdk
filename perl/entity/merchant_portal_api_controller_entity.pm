# BluefinTecsMerchantPortal SDK MerchantPortalApiController entity
...
package MerchantPortalApiControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_api_controller',
    _client => $client,
...
sub make {
  ...
  return MerchantPortalApiControllerEntity->new($self->{_client}, $opts);
}
...
# Returns the current MerchantPortalApiController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalApiController fields).
sub match_get {
  my ($self) = @_;
...
# Create a new MerchantPortalApiController.
#
# reqdata: body data hashref (MerchantPortalApiControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalApiController data (hashref); dies
