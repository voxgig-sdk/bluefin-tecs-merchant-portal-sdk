...
package MerchantPortalPamMandatorControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_pam_mandator_controller',
    _client => $client,
...
# Returns the current MerchantPortalPamMandatorController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalPamMandatorController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (MerchantPortalPamMandatorControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalPamMandatorController data (hashref); dies
