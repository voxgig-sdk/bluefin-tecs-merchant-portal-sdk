...
package MerchantPortalPamPackageControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_pam_package_controller',
    _client => $client,
...
# Returns the current MerchantPortalPamPackageController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalPamPackageController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (MerchantPortalPamPackageControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalPamPackageController data (hashref); dies
