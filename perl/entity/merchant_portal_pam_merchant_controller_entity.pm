...
package MerchantPortalPamMerchantControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_pam_merchant_controller',
    _client => $client,
...
# Returns the current MerchantPortalPamMerchantController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalPamMerchantController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (MerchantPortalPamMerchantControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalPamMerchantController data (hashref); dies
