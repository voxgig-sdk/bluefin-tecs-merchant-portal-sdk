...
package MerchantPortalPamDocumentControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_pam_document_controller',
    _client => $client,
...
# Returns the current MerchantPortalPamDocumentController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalPamDocumentController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (MerchantPortalPamDocumentControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalPamDocumentController data (hashref); dies
