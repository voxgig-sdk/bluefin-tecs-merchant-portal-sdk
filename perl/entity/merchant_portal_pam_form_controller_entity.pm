...
package MerchantPortalPamFormControllerEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'merchant_portal_pam_form_controller',
    _client => $client,
...
# Returns the current MerchantPortalPamFormController data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of MerchantPortalPamFormController fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (MerchantPortalPamFormControllerCreateData shape). ctrl: optional
# per-call control. Returns the created MerchantPortalPamFormController data (hashref); dies
