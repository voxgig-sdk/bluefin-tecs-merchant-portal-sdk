...
from bluefintecsmerchantportal_sdk.core.helpers import get_ctx_prop, to_map
...
class BluefinTecsMerchantPortalContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinTecsMerchantPortalControl()
        ...
        if isinstance(sp, BluefinTecsMerchantPortalSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinTecsMerchantPortalResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinTecsMerchantPortalResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinTecsMerchantPortalOperation({})
        ...
        op = BluefinTecsMerchantPortalOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BluefinTecsMerchantPortalError(code, msg, self)
