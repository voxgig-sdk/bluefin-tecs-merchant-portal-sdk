...
class MerchantPortalPamDocumentControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamDocumentControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamDocumentController:
    ...
    def match_get(self) -> MerchantPortalPamDocumentController:
    ...
    def create(self, reqdata: MerchantPortalPamDocumentControllerCreateData, ctrl=None) -> MerchantPortalPamDocumentController:
        utility = self._utility
