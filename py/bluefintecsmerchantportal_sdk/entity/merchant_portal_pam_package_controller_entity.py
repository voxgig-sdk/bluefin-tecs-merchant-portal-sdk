...
class MerchantPortalPamPackageControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamPackageControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamPackageController:
    ...
    def match_get(self) -> MerchantPortalPamPackageController:
    ...
    def create(self, reqdata: MerchantPortalPamPackageControllerCreateData, ctrl=None) -> MerchantPortalPamPackageController:
        utility = self._utility
