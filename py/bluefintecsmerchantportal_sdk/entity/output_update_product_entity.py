...
class OutputUpdateProductEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputUpdateProductEntity(self._client, opts)
    ...
    def data_get(self) -> OutputUpdateProduct:
    ...
    def match_get(self) -> OutputUpdateProduct:
    ...
    def create(self, reqdata: OutputUpdateProductCreateData, ctrl=None) -> OutputUpdateProduct:
        utility = self._utility
