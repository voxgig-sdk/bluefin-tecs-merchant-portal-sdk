...
class OutputCreateProductEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputCreateProductEntity(self._client, opts)
    ...
    def data_get(self) -> OutputCreateProduct:
    ...
    def match_get(self) -> OutputCreateProduct:
    ...
    def create(self, reqdata: OutputCreateProductCreateData, ctrl=None) -> OutputCreateProduct:
        utility = self._utility
