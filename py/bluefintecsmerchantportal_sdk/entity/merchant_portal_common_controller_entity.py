...
from bluefintecsmerchantportal_sdk.bluefintecsmerchantportal_types import (
...
class MerchantPortalCommonControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalCommonControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalCommonController:
    ...
    def match_get(self) -> MerchantPortalCommonController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MerchantPortalCommonController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MerchantPortalCommonController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
