...
class MerchantPortalPamContractControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamContractControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamContractController:
    ...
    def match_get(self) -> MerchantPortalPamContractController:
    ...
    def create(self, reqdata: MerchantPortalPamContractControllerCreateData, ctrl=None) -> MerchantPortalPamContractController:
        utility = self._utility
