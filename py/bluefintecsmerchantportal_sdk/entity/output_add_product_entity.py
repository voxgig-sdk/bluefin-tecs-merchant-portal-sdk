...
class OutputAddProductEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputAddProductEntity(self._client, opts)
    ...
    def data_get(self) -> OutputAddProduct:
    ...
    def match_get(self) -> OutputAddProduct:
    ...
    def create(self, reqdata: OutputAddProductCreateData, ctrl=None) -> OutputAddProduct:
        utility = self._utility
