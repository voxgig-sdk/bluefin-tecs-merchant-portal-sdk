...
class MerchantPortalPamProductControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamProductControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamProductController:
    ...
    def match_get(self) -> MerchantPortalPamProductController:
    ...
    def create(self, reqdata: MerchantPortalPamProductControllerCreateData, ctrl=None) -> MerchantPortalPamProductController:
        utility = self._utility
