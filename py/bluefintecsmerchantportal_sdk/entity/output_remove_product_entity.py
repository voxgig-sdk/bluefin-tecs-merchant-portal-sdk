...
class OutputRemoveProductEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputRemoveProductEntity(self._client, opts)
    ...
    def data_get(self) -> OutputRemoveProduct:
    ...
    def match_get(self) -> OutputRemoveProduct:
    ...
    def create(self, reqdata: OutputRemoveProductCreateData, ctrl=None) -> OutputRemoveProduct:
        utility = self._utility
