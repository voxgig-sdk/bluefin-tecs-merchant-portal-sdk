...
class MerchantPortalPamMandatorControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamMandatorControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamMandatorController:
    ...
    def match_get(self) -> MerchantPortalPamMandatorController:
    ...
    def create(self, reqdata: MerchantPortalPamMandatorControllerCreateData, ctrl=None) -> MerchantPortalPamMandatorController:
        utility = self._utility
