...
class OutputStartEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputStartEntity(self._client, opts)
    ...
    def match_get(self) -> OutputStart:
    ...
    def create(self, reqdata: OutputStartCreateData, ctrl=None) -> OutputStart:
        utility = self._utility
