...
class OutputListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListEntity(self._client, opts)
    ...
    def create(self, reqdata: OutputListCreateData, ctrl=None) -> OutputList:
        utility = self._utility
