...
class MerchantPortalPamFormControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamFormControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamFormController:
    ...
    def match_get(self) -> MerchantPortalPamFormController:
    ...
    def create(self, reqdata: MerchantPortalPamFormControllerCreateData, ctrl=None) -> MerchantPortalPamFormController:
        utility = self._utility
