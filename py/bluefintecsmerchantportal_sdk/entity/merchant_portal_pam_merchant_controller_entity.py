...
class MerchantPortalPamMerchantControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalPamMerchantControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalPamMerchantController:
    ...
    def match_get(self) -> MerchantPortalPamMerchantController:
    ...
    def create(self, reqdata: MerchantPortalPamMerchantControllerCreateData, ctrl=None) -> MerchantPortalPamMerchantController:
        utility = self._utility
