...
class OutputMoveTidEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputMoveTidEntity(self._client, opts)
    ...
    def data_get(self) -> OutputMoveTid:
    ...
    def match_get(self) -> OutputMoveTid:
    ...
    def create(self, reqdata: OutputMoveTidCreateData, ctrl=None) -> OutputMoveTid:
        utility = self._utility
