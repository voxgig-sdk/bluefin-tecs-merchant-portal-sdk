...
class MerchantPortalApiControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPortalApiControllerEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPortalApiController:
    ...
    def match_get(self) -> MerchantPortalApiController:
    ...
    def create(self, reqdata: MerchantPortalApiControllerCreateData, ctrl=None) -> MerchantPortalApiController:
        utility = self._utility
