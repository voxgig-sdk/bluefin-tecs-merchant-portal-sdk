# BluefinTecsMerchantPortal SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinTecsMerchantPortalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinTecsMerchantPortalSDK(...) and BluefinTecsMerchantPortalSDK.test(...) become
#      BluefinTecsMerchantPortalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefintecsmerchantportal_sdk"
_SDK_CLASS = "BluefinTecsMerchantPortalSDK"
...
_ENTITIES = {
    "MerchantPortalApiController": "merchant_portal_api_controller",
    "MerchantPortalCommonController": "merchant_portal_common_controller",
    "MerchantPortalPamContractController": "merchant_portal_pam_contract_controller",
    "MerchantPortalPamDocumentController": "merchant_portal_pam_document_controller",
    "MerchantPortalPamFormController": "merchant_portal_pam_form_controller",
    "MerchantPortalPamMandatorController": "merchant_portal_pam_mandator_controller",
    "MerchantPortalPamMerchantController": "merchant_portal_pam_merchant_controller",
    "MerchantPortalPamPackageController": "merchant_portal_pam_package_controller",
    "MerchantPortalPamProductController": "merchant_portal_pam_product_controller",
    "OutputAddProduct": "output_add_product",
    "OutputCreateProduct": "output_create_product",
    "OutputDetail": "output_detail",
    "OutputList": "output_list",
    "OutputMessage": "output_message",
    "OutputMoveTid": "output_move_tid",
    "OutputRemoveProduct": "output_remove_product",
    "OutputStart": "output_start",
    "OutputStatus": "output_status",
    "OutputUpdateProduct": "output_update_product",
}
