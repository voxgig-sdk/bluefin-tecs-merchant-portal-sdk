// MerchantPortalApiController entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *MerchantPortalApiControllerEntity,
...
pub const MerchantPortalApiControllerEntity = struct {
    name: []const u8 = "merchant_portal_api_controller",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *MerchantPortalApiControllerEntity {
        ...
        const e = h.A().create(MerchantPortalApiControllerEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *MerchantPortalApiControllerEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *MerchantPortalApiControllerEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *MerchantPortalApiControllerEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *MerchantPortalApiControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalApiControllerEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *MerchantPortalApiControllerEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *MerchantPortalApiControllerEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *MerchantPortalApiControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalApiControllerEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *MerchantPortalApiControllerEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *MerchantPortalApiControllerEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return MerchantPortalApiControllerEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *MerchantPortalApiControllerEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *MerchantPortalApiControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *MerchantPortalApiControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *MerchantPortalApiControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MerchantPortalApiControllerEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MerchantPortalApiControllerEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *MerchantPortalApiControllerEntity, ctx: *Context) void {
    ...
    pub fn update(self: *MerchantPortalApiControllerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalApiControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
