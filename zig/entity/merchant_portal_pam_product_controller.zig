// MerchantPortalPamProductController entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *MerchantPortalPamProductControllerEntity,
...
pub const MerchantPortalPamProductControllerEntity = struct {
    name: []const u8 = "merchant_portal_pam_product_controller",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *MerchantPortalPamProductControllerEntity {
        ...
        const e = h.A().create(MerchantPortalPamProductControllerEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *MerchantPortalPamProductControllerEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *MerchantPortalPamProductControllerEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *MerchantPortalPamProductControllerEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *MerchantPortalPamProductControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalPamProductControllerEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *MerchantPortalPamProductControllerEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *MerchantPortalPamProductControllerEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *MerchantPortalPamProductControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalPamProductControllerEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *MerchantPortalPamProductControllerEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *MerchantPortalPamProductControllerEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return MerchantPortalPamProductControllerEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *MerchantPortalPamProductControllerEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *MerchantPortalPamProductControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *MerchantPortalPamProductControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *MerchantPortalPamProductControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MerchantPortalPamProductControllerEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MerchantPortalPamProductControllerEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *MerchantPortalPamProductControllerEntity, ctx: *Context) void {
    ...
    pub fn update(self: *MerchantPortalPamProductControllerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalPamProductControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
