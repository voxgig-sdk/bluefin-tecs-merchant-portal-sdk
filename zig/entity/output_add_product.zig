// OutputAddProduct entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputAddProductEntity = struct {
    name: []const u8 = "output_add_product",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *OutputAddProductEntity {
        ...
        const e = h.A().create(OutputAddProductEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputAddProductEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputAddProductEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputAddProductEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputAddProductEntity, ctx: *Context, post_done: *const fn (*OutputAddProductEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputAddProductEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputAddProductEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputAddProductEntity, ctx: *Context, post_done: *const fn (*OutputAddProductEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputAddProductEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputAddProductEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputAddProductEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputAddProductEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputAddProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputAddProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputAddProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputAddProductEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputAddProductEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputAddProductEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputAddProductEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputAddProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
