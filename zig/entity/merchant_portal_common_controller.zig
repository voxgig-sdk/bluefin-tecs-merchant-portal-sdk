// MerchantPortalCommonController entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *MerchantPortalCommonControllerEntity,
...
pub const MerchantPortalCommonControllerEntity = struct {
    name: []const u8 = "merchant_portal_common_controller",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *MerchantPortalCommonControllerEntity {
        ...
        const e = h.A().create(MerchantPortalCommonControllerEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *MerchantPortalCommonControllerEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *MerchantPortalCommonControllerEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *MerchantPortalCommonControllerEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *MerchantPortalCommonControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalCommonControllerEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *MerchantPortalCommonControllerEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *MerchantPortalCommonControllerEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *MerchantPortalCommonControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalCommonControllerEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *MerchantPortalCommonControllerEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *MerchantPortalCommonControllerEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return MerchantPortalCommonControllerEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *MerchantPortalCommonControllerEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *MerchantPortalCommonControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *MerchantPortalCommonControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *MerchantPortalCommonControllerEntity, reqmatch: Value, ctrl: Value) EntResult {
    ...
    fn load_post_done(self: *MerchantPortalCommonControllerEntity, ctx: *Context) void {
    ...
    pub fn list(self: *MerchantPortalCommonControllerEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("list", self.name) };
    }

    pub fn create(self: *MerchantPortalCommonControllerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *MerchantPortalCommonControllerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalCommonControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
