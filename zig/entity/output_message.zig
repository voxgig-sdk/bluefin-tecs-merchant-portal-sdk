// OutputMessage entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputMessageEntity = struct {
    name: []const u8 = "output_message",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *OutputMessageEntity {
        ...
        const e = h.A().create(OutputMessageEntity) catch unreachable;
        e.* = .{
            .name = "output_message",
            .client = client,
    ...
    fn ent_ctx(self: *OutputMessageEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputMessageEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputMessageEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputMessageEntity, ctx: *Context, post_done: *const fn (*OutputMessageEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputMessageEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputMessageEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputMessageEntity, ctx: *Context, post_done: *const fn (*OutputMessageEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputMessageEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputMessageEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputMessageEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputMessageEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputMessageEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputMessageEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputMessageEntity, reqmatch: Value, ctrl: Value) EntResult {
    ...
    fn load_post_done(self: *OutputMessageEntity, ctx: *Context) void {
    ...
    pub fn list(self: *OutputMessageEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("list", self.name) };
    }

    pub fn create(self: *OutputMessageEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *OutputMessageEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputMessageEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
