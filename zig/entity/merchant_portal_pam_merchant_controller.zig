...
pub const MerchantPortalPamMerchantControllerEntity = struct {
    ...
    pub fn load(self: *MerchantPortalPamMerchantControllerEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MerchantPortalPamMerchantControllerEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MerchantPortalPamMerchantControllerEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *MerchantPortalPamMerchantControllerEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalPamMerchantControllerEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
