// MerchantPortalPamMerchantController entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *MerchantPortalPamMerchantControllerEntity,
...
pub const MerchantPortalPamMerchantControllerEntity = struct {
    name: []const u8 = "merchant_portal_pam_merchant_controller",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *MerchantPortalPamMerchantControllerEntity {
        ...
        const e = h.A().create(MerchantPortalPamMerchantControllerEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *MerchantPortalPamMerchantControllerEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *MerchantPortalPamMerchantControllerEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *MerchantPortalPamMerchantControllerEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *MerchantPortalPamMerchantControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalPamMerchantControllerEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *MerchantPortalPamMerchantControllerEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *MerchantPortalPamMerchantControllerEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *MerchantPortalPamMerchantControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalPamMerchantControllerEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *MerchantPortalPamMerchantControllerEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *MerchantPortalPamMerchantControllerEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return MerchantPortalPamMerchantControllerEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *MerchantPortalPamMerchantControllerEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *MerchantPortalPamMerchantControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *MerchantPortalPamMerchantControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *MerchantPortalPamMerchantControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MerchantPortalPamMerchantControllerEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MerchantPortalPamMerchantControllerEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *MerchantPortalPamMerchantControllerEntity, ctx: *Context) void {
    ...
    pub fn update(self: *MerchantPortalPamMerchantControllerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalPamMerchantControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
