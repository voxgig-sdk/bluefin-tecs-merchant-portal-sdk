// OutputCreateProduct entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputCreateProductEntity = struct {
    name: []const u8 = "output_create_product",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *OutputCreateProductEntity {
        ...
        const e = h.A().create(OutputCreateProductEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputCreateProductEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputCreateProductEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputCreateProductEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputCreateProductEntity, ctx: *Context, post_done: *const fn (*OutputCreateProductEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputCreateProductEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputCreateProductEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputCreateProductEntity, ctx: *Context, post_done: *const fn (*OutputCreateProductEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputCreateProductEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputCreateProductEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputCreateProductEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputCreateProductEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputCreateProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputCreateProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputCreateProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputCreateProductEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputCreateProductEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputCreateProductEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputCreateProductEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputCreateProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
