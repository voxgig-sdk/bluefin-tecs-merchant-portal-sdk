// OutputRemoveProduct entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputRemoveProductEntity = struct {
    name: []const u8 = "output_remove_product",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *OutputRemoveProductEntity {
        ...
        const e = h.A().create(OutputRemoveProductEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputRemoveProductEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputRemoveProductEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputRemoveProductEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputRemoveProductEntity, ctx: *Context, post_done: *const fn (*OutputRemoveProductEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputRemoveProductEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputRemoveProductEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputRemoveProductEntity, ctx: *Context, post_done: *const fn (*OutputRemoveProductEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputRemoveProductEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputRemoveProductEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputRemoveProductEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputRemoveProductEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputRemoveProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputRemoveProductEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputRemoveProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputRemoveProductEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputRemoveProductEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputRemoveProductEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputRemoveProductEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputRemoveProductEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
