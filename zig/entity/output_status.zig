// OutputStatus entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputStatusEntity = struct {
    name: []const u8 = "output_status",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *OutputStatusEntity {
        ...
        const e = h.A().create(OutputStatusEntity) catch unreachable;
        e.* = .{
            .name = "output_status",
            .client = client,
    ...
    fn ent_ctx(self: *OutputStatusEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputStatusEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputStatusEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputStatusEntity, ctx: *Context, post_done: *const fn (*OutputStatusEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputStatusEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputStatusEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputStatusEntity, ctx: *Context, post_done: *const fn (*OutputStatusEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputStatusEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputStatusEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputStatusEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputStatusEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputStatusEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputStatusEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputStatusEntity, reqmatch: Value, ctrl: Value) EntResult {
    ...
    fn load_post_done(self: *OutputStatusEntity, ctx: *Context) void {
    ...
    pub fn list(self: *OutputStatusEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("list", self.name) };
    }

    pub fn create(self: *OutputStatusEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *OutputStatusEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputStatusEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
