// MerchantPortalPamFormController entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *MerchantPortalPamFormControllerEntity,
...
pub const MerchantPortalPamFormControllerEntity = struct {
    name: []const u8 = "merchant_portal_pam_form_controller",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *MerchantPortalPamFormControllerEntity {
        ...
        const e = h.A().create(MerchantPortalPamFormControllerEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *MerchantPortalPamFormControllerEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *MerchantPortalPamFormControllerEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *MerchantPortalPamFormControllerEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *MerchantPortalPamFormControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalPamFormControllerEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *MerchantPortalPamFormControllerEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *MerchantPortalPamFormControllerEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *MerchantPortalPamFormControllerEntity, ctx: *Context, post_done: *const fn (*MerchantPortalPamFormControllerEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *MerchantPortalPamFormControllerEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *MerchantPortalPamFormControllerEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return MerchantPortalPamFormControllerEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *MerchantPortalPamFormControllerEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *MerchantPortalPamFormControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *MerchantPortalPamFormControllerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *MerchantPortalPamFormControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *MerchantPortalPamFormControllerEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *MerchantPortalPamFormControllerEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *MerchantPortalPamFormControllerEntity, ctx: *Context) void {
    ...
    pub fn update(self: *MerchantPortalPamFormControllerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *MerchantPortalPamFormControllerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
