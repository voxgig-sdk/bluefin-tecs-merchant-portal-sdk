// OutputList entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputListEntity = struct {
    name: []const u8 = "output_list",
    ...
    pub fn new(client: *sdk.BluefinTecsMerchantPortalSDK, entopts_in: Value) *OutputListEntity {
        ...
        const e = h.A().create(OutputListEntity) catch unreachable;
        e.* = .{
            .name = "output_list",
            .client = client,
    ...
    fn ent_ctx(self: *OutputListEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputListEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputListEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputListEntity, ctx: *Context, post_done: *const fn (*OutputListEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputListEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputListEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputListEntity, ctx: *Context, post_done: *const fn (*OutputListEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputListEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputListEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputListEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputListEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputListEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputListEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputListEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputListEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputListEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputListEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputListEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputListEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
