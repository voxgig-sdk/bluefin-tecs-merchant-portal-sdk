// BluefinTecsMerchantPortalSDK client (generated — mirrors the go/rust Main fragment).
...
pub const BluefinTecsMerchantPortalSDK = struct {
    mode: []const u8 = "live",
    options: Value = .{ .null = {} },
    ...
    pub fn new(options: Value) *BluefinTecsMerchantPortalSDK {
    ...
    pub fn new_with(options: Value, extend: []const Feature) *BluefinTecsMerchantPortalSDK {
        const sdk = h.A().create(BluefinTecsMerchantPortalSDK) catch unreachable;
        sdk.* = .{
            .mode = "live",
            .options = h.vnull(),
    ...
    pub fn options_map(self: *BluefinTecsMerchantPortalSDK) Value {
        return h.clone(self.options);
    }

    pub fn get_utility(self: *BluefinTecsMerchantPortalSDK) *Utility {
        return Utility.copy(self.sdkUtility);
    }

    pub fn get_root_ctx(self: *BluefinTecsMerchantPortalSDK) *Context {
        return self.rootctx orelse unreachable;
    }

    pub fn prepare(self: *BluefinTecsMerchantPortalSDK, fetchargs_in: Value) E!Value {
    ...
    pub fn direct(self: *BluefinTecsMerchantPortalSDK, fetchargs_in: Value) Value {
    ...
    fn op_allowed(self: *BluefinTecsMerchantPortalSDK, op: []const u8) bool {
    ...
    fn op_denied(self: *BluefinTecsMerchantPortalSDK, op: []const u8) Value {
        const allow: []const u8 = switch (h.getpath(&.{ "allow", "op" }, self.options)) {
            .string => |s| s,
            else => "",
        };
        const msg = std.fmt.allocPrint(h.A(),
            "BluefinTecsMerchantPortalSDK: {s}: operation not allowed by" ++
    ...
    // gate by passing it.
    fn raw_request(self: *BluefinTecsMerchantPortalSDK, fetchargs_in: Value) Value {
    ...
    pub fn graphql(
        self: *BluefinTecsMerchantPortalSDK, query: []const u8, variables: Value, ctrl: Value,
    ) Value {
        ...
        if (errors == .array and 0 < errors.array.data.items.len) {
            ...
            const msg = std.fmt.allocPrint(h.A(),
                "BluefinTecsMerchantPortalSDK: graphql: {s}", .{m}) catch "";
    ...
    pub fn merchant_portal_api_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_api_controller.zig").MerchantPortalApiControllerEntity {
        return @import("../entity/merchant_portal_api_controller.zig").MerchantPortalApiControllerEntity.new(self, entopts);
    }

    /// MerchantPortalCommonController entity bound to this client.
    pub fn merchant_portal_common_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_common_controller.zig").MerchantPortalCommonControllerEntity {
        return @import("../entity/merchant_portal_common_controller.zig").MerchantPortalCommonControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamContractController entity bound to this client.
    pub fn merchant_portal_pam_contract_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_contract_controller.zig").MerchantPortalPamContractControllerEntity {
        return @import("../entity/merchant_portal_pam_contract_controller.zig").MerchantPortalPamContractControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamDocumentController entity bound to this client.
    pub fn merchant_portal_pam_document_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_document_controller.zig").MerchantPortalPamDocumentControllerEntity {
        return @import("../entity/merchant_portal_pam_document_controller.zig").MerchantPortalPamDocumentControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamFormController entity bound to this client.
    pub fn merchant_portal_pam_form_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_form_controller.zig").MerchantPortalPamFormControllerEntity {
        return @import("../entity/merchant_portal_pam_form_controller.zig").MerchantPortalPamFormControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamMandatorController entity bound to this client.
    pub fn merchant_portal_pam_mandator_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_mandator_controller.zig").MerchantPortalPamMandatorControllerEntity {
        return @import("../entity/merchant_portal_pam_mandator_controller.zig").MerchantPortalPamMandatorControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamMerchantController entity bound to this client.
    pub fn merchant_portal_pam_merchant_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_merchant_controller.zig").MerchantPortalPamMerchantControllerEntity {
        return @import("../entity/merchant_portal_pam_merchant_controller.zig").MerchantPortalPamMerchantControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamPackageController entity bound to this client.
    pub fn merchant_portal_pam_package_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_package_controller.zig").MerchantPortalPamPackageControllerEntity {
        return @import("../entity/merchant_portal_pam_package_controller.zig").MerchantPortalPamPackageControllerEntity.new(self, entopts);
    }

    /// MerchantPortalPamProductController entity bound to this client.
    pub fn merchant_portal_pam_product_controller(self: *@This(), entopts: Value) *@import("../entity/merchant_portal_pam_product_controller.zig").MerchantPortalPamProductControllerEntity {
        return @import("../entity/merchant_portal_pam_product_controller.zig").MerchantPortalPamProductControllerEntity.new(self, entopts);
    }

    /// OutputAddProduct entity bound to this client.
    pub fn output_add_product(self: *@This(), entopts: Value) *@import("../entity/output_add_product.zig").OutputAddProductEntity {
        return @import("../entity/output_add_product.zig").OutputAddProductEntity.new(self, entopts);
    }

    /// OutputCreateProduct entity bound to this client.
    pub fn output_create_product(self: *@This(), entopts: Value) *@import("../entity/output_create_product.zig").OutputCreateProductEntity {
        return @import("../entity/output_create_product.zig").OutputCreateProductEntity.new(self, entopts);
    }

    /// OutputDetail entity bound to this client.
    pub fn output_detail(self: *@This(), entopts: Value) *@import("../entity/output_detail.zig").OutputDetailEntity {
        return @import("../entity/output_detail.zig").OutputDetailEntity.new(self, entopts);
    }

    /// OutputList entity bound to this client.
    pub fn output_list(self: *@This(), entopts: Value) *@import("../entity/output_list.zig").OutputListEntity {
        return @import("../entity/output_list.zig").OutputListEntity.new(self, entopts);
    }

    /// OutputMessage entity bound to this client.
    pub fn output_message(self: *@This(), entopts: Value) *@import("../entity/output_message.zig").OutputMessageEntity {
        return @import("../entity/output_message.zig").OutputMessageEntity.new(self, entopts);
    }

    /// OutputMoveTid entity bound to this client.
    pub fn output_move_tid(self: *@This(), entopts: Value) *@import("../entity/output_move_tid.zig").OutputMoveTidEntity {
        return @import("../entity/output_move_tid.zig").OutputMoveTidEntity.new(self, entopts);
    }

    /// OutputRemoveProduct entity bound to this client.
    pub fn output_remove_product(self: *@This(), entopts: Value) *@import("../entity/output_remove_product.zig").OutputRemoveProductEntity {
        return @import("../entity/output_remove_product.zig").OutputRemoveProductEntity.new(self, entopts);
    }

    /// OutputStart entity bound to this client.
    pub fn output_start(self: *@This(), entopts: Value) *@import("../entity/output_start.zig").OutputStartEntity {
        return @import("../entity/output_start.zig").OutputStartEntity.new(self, entopts);
    }

    /// OutputStatus entity bound to this client.
    pub fn output_status(self: *@This(), entopts: Value) *@import("../entity/output_status.zig").OutputStatusEntity {
        return @import("../entity/output_status.zig").OutputStatusEntity.new(self, entopts);
    }

    /// OutputUpdateProduct entity bound to this client.
    pub fn output_update_product(self: *@This(), entopts: Value) *@import("../entity/output_update_product.zig").OutputUpdateProductEntity {
        return @import("../entity/output_update_product.zig").OutputUpdateProductEntity.new(self, entopts);
    }

};

pub fn test_sdk(testopts_in: Value, sdkopts_in: Value) *BluefinTecsMerchantPortalSDK {
    ...
    const sdk = BluefinTecsMerchantPortalSDK.new(sdkopts);
    sdk.mode = "test";
