...
public abstract class BluefinTecsMerchantPortalEntityBase : IEntity
{
    protected string name;
    protected BluefinTecsMerchantPortalSDK client;
    ...
    protected BluefinTecsMerchantPortalEntityBase(BluefinTecsMerchantPortalSDK client,
