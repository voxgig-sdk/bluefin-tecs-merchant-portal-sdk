...
public class OutputMessageDirectTest
{
    ...
    private static OutputMessageDirectSetupResult OutputMessageDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_MESSAGE_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var entidRaw = env["BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_MESSAGE_ENTID"];
