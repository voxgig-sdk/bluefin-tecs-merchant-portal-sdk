...
public class OutputMoveTidEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_MOVE_TID_ENTID JSON to run live.
        ...
        outputMoveTidRef01Data = Helpers.ToMapAny(outputMoveTidRef01DataResult is IEntity ce ? ce.Data() : outputMoveTidRef01DataResult);
