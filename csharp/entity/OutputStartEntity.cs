...
public class OutputStartEntity : BluefinTecsMerchantPortalEntityBase
{
    public OutputStartEntity(BluefinTecsMerchantPortalSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_start")
    {
    }

    public override IEntity Make()
    {
        return new OutputStartEntity(client, CloneOpts());
    }
