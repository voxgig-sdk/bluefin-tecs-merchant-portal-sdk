...
public class OutputMessageEntity : BluefinTecsMerchantPortalEntityBase
{
    public OutputMessageEntity(BluefinTecsMerchantPortalSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_message")
    {
    }

    public override IEntity Make()
    {
        return new OutputMessageEntity(client, CloneOpts());
    }
