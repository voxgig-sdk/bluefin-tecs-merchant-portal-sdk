// OutputDetail entity client for the BluefinTecsMerchantPortal SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantPortalSdk.Entity;

public class OutputDetailEntity : BluefinTecsMerchantPortalEntityBase
{
    public OutputDetailEntity(BluefinTecsMerchantPortalSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_detail")
    {
    }

    public override IEntity Make()
    {
        return new OutputDetailEntity(client, CloneOpts());
    }
