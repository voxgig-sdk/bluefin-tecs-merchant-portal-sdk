// OutputList entity client for the BluefinTecsMerchantPortal SDK.

using Voxgig.Struct;

namespace BluefinTecsMerchantPortalSdk.Entity;

public class OutputListEntity : BluefinTecsMerchantPortalEntityBase
{
    public OutputListEntity(BluefinTecsMerchantPortalSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_list")
    {
    }

    public override IEntity Make()
    {
        return new OutputListEntity(client, CloneOpts());
    }
