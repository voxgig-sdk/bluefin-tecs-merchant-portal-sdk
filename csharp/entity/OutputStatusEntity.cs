...
public class OutputStatusEntity : BluefinTecsMerchantPortalEntityBase
{
    public OutputStatusEntity(BluefinTecsMerchantPortalSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_status")
    {
    }

    public override IEntity Make()
    {
        return new OutputStatusEntity(client, CloneOpts());
    }
