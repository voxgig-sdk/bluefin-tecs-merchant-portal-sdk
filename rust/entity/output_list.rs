// OutputList entity client (generated — mirrors the go Entity fragment).
...
impl OutputListEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputListEntity> {
        ...
        let e = Rc::new(OutputListEntity {
            name: "output_list".to_string(),
            client: client.clone(),
...
impl Entity for OutputListEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputListEntity {
