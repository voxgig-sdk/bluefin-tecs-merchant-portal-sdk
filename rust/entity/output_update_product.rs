// OutputUpdateProduct entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputUpdateProductEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputUpdateProductEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputUpdateProductEntity> {
        ...
        let e = Rc::new(OutputUpdateProductEntity {
            name: "output_update_product".to_string(),
            client: client.clone(),
...
impl Entity for OutputUpdateProductEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputUpdateProductEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputUpdateProductEntity {
