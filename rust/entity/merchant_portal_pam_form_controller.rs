// MerchantPortalPamFormController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalPamFormControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamFormControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamFormControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamFormControllerEntity {
            name: "merchant_portal_pam_form_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalPamFormControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamFormControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamFormControllerEntity {
