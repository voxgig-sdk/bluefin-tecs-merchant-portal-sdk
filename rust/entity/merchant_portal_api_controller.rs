// MerchantPortalApiController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalApiControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalApiControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalApiControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalApiControllerEntity {
            name: "merchant_portal_api_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalApiControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalApiControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalApiControllerEntity {
