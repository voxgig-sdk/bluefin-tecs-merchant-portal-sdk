// OutputMessage entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputMessageEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputMessageEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputMessageEntity> {
        ...
        let e = Rc::new(OutputMessageEntity {
            name: "output_message".to_string(),
            client: client.clone(),
...
impl Entity for OutputMessageEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputMessageEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputMessageEntity {
