// OutputRemoveProduct entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputRemoveProductEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputRemoveProductEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputRemoveProductEntity> {
        ...
        let e = Rc::new(OutputRemoveProductEntity {
            name: "output_remove_product".to_string(),
            client: client.clone(),
...
impl Entity for OutputRemoveProductEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputRemoveProductEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputRemoveProductEntity {
