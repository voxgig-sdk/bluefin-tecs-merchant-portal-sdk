// MerchantPortalPamContractController entity client (generated — mirrors the go Entity fragment).
...
use crate::core::sdk::BluefinTecsMerchantPortalSDK;
use crate::core::types::{Entity, BluefinTecsMerchantPortalEntity};
use crate::core::utility_type::Utility;
use crate::utility::voxgigstruct as vs;
use crate::utility::voxgigstruct::Value;

pub struct MerchantPortalPamContractControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamContractControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamContractControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamContractControllerEntity {
            name: "merchant_portal_pam_contract_controller".to_string(),
            client: client.clone(),
    ...
    ) -> Result<Value, BluefinTecsMerchantPortalError> {
    ...
    pub fn stream(
        ...
        args: Value,
        callopts: Value,
    ) -> Result<std::vec::IntoIter<Value>, BluefinTecsMerchantPortalError> {
...
impl Entity for MerchantPortalPamContractControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamContractControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamContractControllerEntity {
    fn load(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantPortalError> {
        Err(crate::core::helpers::unsupported_op("load", &self.name))
    }

    fn list(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Vec<Rc<Self>>, BluefinTecsMerchantPortalError> {
        Err(crate::core::helpers::unsupported_op("list", &self.name))
    }


    fn create(self: &Rc<Self>, reqdata: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantPortalError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn update(self: &Rc<Self>, _reqdata: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantPortalError> {
        Err(crate::core::helpers::unsupported_op("update", &self.name))
    }

    fn remove(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantPortalError> {
