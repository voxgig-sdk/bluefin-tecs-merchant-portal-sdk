// OutputStart entity client (generated — mirrors the go Entity fragment).
...
impl OutputStartEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputStartEntity> {
        ...
        let e = Rc::new(OutputStartEntity {
            name: "output_start".to_string(),
            client: client.clone(),
...
impl Entity for OutputStartEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputStartEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputStartEntity {
