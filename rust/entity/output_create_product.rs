// OutputCreateProduct entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputCreateProductEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputCreateProductEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputCreateProductEntity> {
        ...
        let e = Rc::new(OutputCreateProductEntity {
            name: "output_create_product".to_string(),
            client: client.clone(),
...
impl Entity for OutputCreateProductEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputCreateProductEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputCreateProductEntity {
