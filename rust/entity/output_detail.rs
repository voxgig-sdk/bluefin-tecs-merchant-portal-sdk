// OutputDetail entity client (generated — mirrors the go Entity fragment).
...
impl OutputDetailEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputDetailEntity> {
        ...
        let e = Rc::new(OutputDetailEntity {
            name: "output_detail".to_string(),
            client: client.clone(),
...
impl Entity for OutputDetailEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputDetailEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputDetailEntity {
