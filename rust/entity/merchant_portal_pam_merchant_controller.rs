...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamMerchantControllerEntity {
    fn load(&self, _reqmatch: Value, _ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
        Err(crate::core::helpers::unsupported_op("load", &self.name))
    }

    fn list(&self, _reqmatch: Value, _ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
        Err(crate::core::helpers::unsupported_op("list", &self.name))
    }


    fn create(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn update(&self, _reqdata: Value, _ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
        Err(crate::core::helpers::unsupported_op("update", &self.name))
    }

    fn remove(&self, _reqmatch: Value, _ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
