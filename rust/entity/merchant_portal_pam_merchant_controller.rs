// MerchantPortalPamMerchantController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalPamMerchantControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamMerchantControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamMerchantControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamMerchantControllerEntity {
            name: "merchant_portal_pam_merchant_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalPamMerchantControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamMerchantControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamMerchantControllerEntity {
