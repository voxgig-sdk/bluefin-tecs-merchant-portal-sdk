// OutputAddProduct entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputAddProductEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputAddProductEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputAddProductEntity> {
        ...
        let e = Rc::new(OutputAddProductEntity {
            name: "output_add_product".to_string(),
            client: client.clone(),
...
impl Entity for OutputAddProductEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputAddProductEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputAddProductEntity {
