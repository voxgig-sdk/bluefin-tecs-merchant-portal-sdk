// MerchantPortalPamDocumentController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalPamDocumentControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamDocumentControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamDocumentControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamDocumentControllerEntity {
            name: "merchant_portal_pam_document_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalPamDocumentControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamDocumentControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamDocumentControllerEntity {
