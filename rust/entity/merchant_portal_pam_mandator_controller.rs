// MerchantPortalPamMandatorController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalPamMandatorControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamMandatorControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamMandatorControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamMandatorControllerEntity {
            name: "merchant_portal_pam_mandator_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalPamMandatorControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamMandatorControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamMandatorControllerEntity {
