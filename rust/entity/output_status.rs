// OutputStatus entity client (generated — mirrors the go Entity fragment).
...
impl OutputStatusEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputStatusEntity> {
        ...
        let e = Rc::new(OutputStatusEntity {
            name: "output_status".to_string(),
            client: client.clone(),
...
impl Entity for OutputStatusEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputStatusEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputStatusEntity {
