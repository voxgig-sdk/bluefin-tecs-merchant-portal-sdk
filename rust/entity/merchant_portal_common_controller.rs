// MerchantPortalCommonController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalCommonControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalCommonControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalCommonControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalCommonControllerEntity {
            name: "merchant_portal_common_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalCommonControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalCommonControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalCommonControllerEntity {

    fn load(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantPortalError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn create(self: &Rc<Self>, _reqdata: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsMerchantPortalError> {
