...
impl BluefinTecsMerchantPortalEntity for MerchantPortalCommonControllerEntity {
    ...
    fn load(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn create(&self, _reqdata: Value, _ctrl: Value) -> Result<Value, BluefinTecsMerchantPortalError> {
