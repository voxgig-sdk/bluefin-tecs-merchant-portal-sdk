// OutputMoveTid entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputMoveTidEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputMoveTidEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<OutputMoveTidEntity> {
        ...
        let e = Rc::new(OutputMoveTidEntity {
            name: "output_move_tid".to_string(),
            client: client.clone(),
...
impl Entity for OutputMoveTidEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputMoveTidEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for OutputMoveTidEntity {
