// MerchantPortalPamPackageController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalPamPackageControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamPackageControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamPackageControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamPackageControllerEntity {
            name: "merchant_portal_pam_package_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalPamPackageControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamPackageControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamPackageControllerEntity {
