// MerchantPortalPamProductController entity client (generated — mirrors the go Entity fragment).
...
pub struct MerchantPortalPamProductControllerEntity {
    name: String,
    #[allow(dead_code)]
...
impl MerchantPortalPamProductControllerEntity {
    pub fn new(client: &Rc<BluefinTecsMerchantPortalSDK>, entopts: Value) -> Rc<MerchantPortalPamProductControllerEntity> {
        ...
        let e = Rc::new(MerchantPortalPamProductControllerEntity {
            name: "merchant_portal_pam_product_controller".to_string(),
            client: client.clone(),
...
impl Entity for MerchantPortalPamProductControllerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MerchantPortalPamProductControllerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsMerchantPortalEntity for MerchantPortalPamProductControllerEntity {
