...
// tm/swift/Tests/BluefinTecsMerchantPortalSDKTests/OmniResolver.swift, and it follows the
...
use bluefin_tecs_merchant_portal_sdk::utility::voxgigstruct::ordered_map::OrderedMap;
use bluefin_tecs_merchant_portal_sdk::utility::voxgigstruct::value::Value;
use bluefin_tecs_merchant_portal_sdk::utility::voxgigstruct::InjectDef;
use bluefin_tecs_merchant_portal_sdk::BluefinTecsMerchantPortalError;
...
pub fn vget(val: &Value, key: &str) -> Value {
    bluefin_tecs_merchant_portal_sdk::utility::voxgigstruct::lookup(val, &Value::str(key))
}
