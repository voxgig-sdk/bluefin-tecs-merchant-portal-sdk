...
fn output_message_direct_setup(mockres: Value) -> OutputMessageDirectSetup {
    ...
    let env = env_override(jo(vec![
        ("BLUEFINTECSMERCHANTPORTAL_TEST_OUTPUT_MESSAGE_ENTID", Value::empty_map()),
    ...
    if live {
        ...
        let idmap = match to_map(&getp(&env, "BLUEFINTECSMERCHANTPORTAL_TEST_OUTPUT_MESSAGE_ENTID")) {
