// BluefinTecsMerchantPortal SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinTecsMerchantPortalError;
...
pub use crate::core::sdk::{test_sdk, BluefinTecsMerchantPortalSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinTecsMerchantPortalEntity,
};
...
// No-argument convenience constructors: `bluefin_tecs_merchant_portal_sdk::new()` /
// `bluefin_tecs_merchant_portal_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinTecsMerchantPortalSDK> {
    BluefinTecsMerchantPortalSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinTecsMerchantPortalSDK> {
