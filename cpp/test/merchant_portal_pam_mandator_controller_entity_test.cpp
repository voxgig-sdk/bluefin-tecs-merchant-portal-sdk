...
static MerchantPortalPamMandatorControllerSetup merchant_portal_pam_mandator_controller_basic_setup(const Value& extra) {
  ...
  Value idmap_resolved = Helpers::toMapAny(getp(env, "BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_MANDATOR_CONTROLLER_ENTID"));
...
static void merchant_portal_pam_mandator_controller_entity_basic() {
  ...
  {
    Value merchant_portal_pam_mandator_controller_ref01_data_result = merchant_portal_pam_mandator_controller_ref01_ent->create(Struct::clone(merchant_portal_pam_mandator_controller_ref01_data), Value::undef())->data();
