...
static MerchantPortalCommonControllerSetup merchant_portal_common_controller_basic_setup(const Value& extra) {
  ...
  Value idmap_resolved = Helpers::toMapAny(getp(env, "BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_COMMON_CONTROLLER_ENTID"));
...
static void merchant_portal_common_controller_entity_basic() {
  ...
  Value merchant_portal_common_controller_ref01_data_dt0_loaded = merchant_portal_common_controller_ref01_ent->load(merchant_portal_common_controller_ref01_match_dt0, Value::undef())->data();
