// MerchantPortalPamFormController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamFormControllerEntity : public EntityBase {
public:
  MerchantPortalPamFormControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_form_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamFormControllerEntity>(this->client, opts);
  }
