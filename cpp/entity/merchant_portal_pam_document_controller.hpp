// MerchantPortalPamDocumentController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamDocumentControllerEntity : public EntityBase {
public:
  MerchantPortalPamDocumentControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_document_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamDocumentControllerEntity>(this->client, opts);
  }
