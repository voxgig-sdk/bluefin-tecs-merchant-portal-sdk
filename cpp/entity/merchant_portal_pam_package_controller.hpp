// MerchantPortalPamPackageController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamPackageControllerEntity : public EntityBase {
public:
  MerchantPortalPamPackageControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_package_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamPackageControllerEntity>(this->client, opts);
  }
