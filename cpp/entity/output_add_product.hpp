// OutputAddProduct entity client (generated). Shared entity runtime (data/match
...
class OutputAddProductEntity : public EntityBase {
public:
  OutputAddProductEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_add_product", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputAddProductEntity>(this->client, opts);
  }
