// OutputStatus entity client (generated). Shared entity runtime (data/match
...
class OutputStatusEntity : public EntityBase {
public:
  OutputStatusEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_status", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputStatusEntity>(this->client, opts);
  }
