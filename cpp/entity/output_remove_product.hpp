// OutputRemoveProduct entity client (generated). Shared entity runtime (data/match
...
class OutputRemoveProductEntity : public EntityBase {
public:
  OutputRemoveProductEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_remove_product", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputRemoveProductEntity>(this->client, opts);
  }
