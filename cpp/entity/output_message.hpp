// OutputMessage entity client (generated). Shared entity runtime (data/match
...
class OutputMessageEntity : public EntityBase {
public:
  OutputMessageEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_message", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputMessageEntity>(this->client, opts);
  }
