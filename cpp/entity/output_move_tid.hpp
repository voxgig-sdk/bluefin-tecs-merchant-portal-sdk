// OutputMoveTid entity client (generated). Shared entity runtime (data/match
...
class OutputMoveTidEntity : public EntityBase {
public:
  OutputMoveTidEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_move_tid", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputMoveTidEntity>(this->client, opts);
  }
