// OutputUpdateProduct entity client (generated). Shared entity runtime (data/match
...
class OutputUpdateProductEntity : public EntityBase {
public:
  OutputUpdateProductEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_update_product", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputUpdateProductEntity>(this->client, opts);
  }
