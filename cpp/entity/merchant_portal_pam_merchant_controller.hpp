// MerchantPortalPamMerchantController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamMerchantControllerEntity : public EntityBase {
public:
  MerchantPortalPamMerchantControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_merchant_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamMerchantControllerEntity>(this->client, opts);
  }
