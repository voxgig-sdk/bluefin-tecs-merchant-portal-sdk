// MerchantPortalPamMandatorController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamMandatorControllerEntity : public EntityBase {
public:
  MerchantPortalPamMandatorControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_mandator_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamMandatorControllerEntity>(this->client, opts);
  }
