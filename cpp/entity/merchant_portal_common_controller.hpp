// MerchantPortalCommonController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalCommonControllerEntity : public EntityBase {
public:
  MerchantPortalCommonControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_common_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalCommonControllerEntity>(this->client, opts);
  }
