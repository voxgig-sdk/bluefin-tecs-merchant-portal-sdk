// OutputList entity client (generated). Shared entity runtime (data/match
...
class OutputListEntity : public EntityBase {
public:
  OutputListEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListEntity>(this->client, opts);
  }
