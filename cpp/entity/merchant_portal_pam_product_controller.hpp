// MerchantPortalPamProductController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamProductControllerEntity : public EntityBase {
public:
  MerchantPortalPamProductControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_product_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamProductControllerEntity>(this->client, opts);
  }
