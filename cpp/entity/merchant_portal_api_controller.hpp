// MerchantPortalApiController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalApiControllerEntity : public EntityBase {
public:
  MerchantPortalApiControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_api_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalApiControllerEntity>(this->client, opts);
  }
