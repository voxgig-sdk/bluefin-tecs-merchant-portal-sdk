// OutputStart entity client (generated). Shared entity runtime (data/match
...
class OutputStartEntity : public EntityBase {
public:
  OutputStartEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_start", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputStartEntity>(this->client, opts);
  }
