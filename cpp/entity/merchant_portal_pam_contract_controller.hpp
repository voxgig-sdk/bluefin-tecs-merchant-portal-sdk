// MerchantPortalPamContractController entity client (generated). Shared entity runtime (data/match
...
class MerchantPortalPamContractControllerEntity : public EntityBase {
public:
  MerchantPortalPamContractControllerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("merchant_portal_pam_contract_controller", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MerchantPortalPamContractControllerEntity>(this->client, opts);
  }
