// OutputCreateProduct entity client (generated). Shared entity runtime (data/match
...
class OutputCreateProductEntity : public EntityBase {
public:
  OutputCreateProductEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_create_product", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputCreateProductEntity>(this->client, opts);
  }
