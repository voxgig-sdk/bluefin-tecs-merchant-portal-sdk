// OutputDetail entity client (generated). Shared entity runtime (data/match
...
class OutputDetailEntity : public EntityBase {
public:
  OutputDetailEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_detail", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputDetailEntity>(this->client, opts);
  }
