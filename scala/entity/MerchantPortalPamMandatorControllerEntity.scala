...
class MerchantPortalPamMandatorControllerEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("merchant_portal_pam_mandator_controller", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MerchantPortalPamMandatorControllerEntity(this.client, opts)
  }
