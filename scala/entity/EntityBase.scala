...
import voxgig.bluefintecsmerchantportalsdk.core.{Context, Helpers, SdkClient, SdkEntity, Utility}
import voxgig.bluefintecsmerchantportalsdk.utility.struct.Struct

// Shared entity runtime for the BluefinTecsMerchantPortal SDK: accreting data/match state,
