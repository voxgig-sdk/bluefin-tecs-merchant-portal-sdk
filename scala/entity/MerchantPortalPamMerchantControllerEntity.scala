...
class MerchantPortalPamMerchantControllerEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("merchant_portal_pam_merchant_controller", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MerchantPortalPamMerchantControllerEntity(this.client, opts)
  }
