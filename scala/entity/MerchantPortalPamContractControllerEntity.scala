...
class MerchantPortalPamContractControllerEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("merchant_portal_pam_contract_controller", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MerchantPortalPamContractControllerEntity(this.client, opts)
  }
