...
class OutputMoveTidEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_move_tid", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputMoveTidEntity(this.client, opts)
  }
