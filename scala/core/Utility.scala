...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefintecsmerchantportalsdk.utility.StructUtility.type = voxgig.bluefintecsmerchantportalsdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefintecsmerchantportalsdk.utility.Register.registerAll(this)
  }
