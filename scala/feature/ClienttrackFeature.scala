package voxgig.bluefintecsmerchantportalsdk.feature

import java.util.{LinkedHashMap, Map => JMap}
import java.util.concurrent.ThreadLocalRandom
import voxgig.bluefintecsmerchantportalsdk.core.{Context, SdkClient}
...
class ClienttrackFeature extends BaseFeature("clienttrack", "0.0.1", true) {
  ...
  private def agentName(): String = {
    val name = FeatureOptions.foptStr(this.options, "clientName", "BluefinTecsMerchantPortal-SDK")
