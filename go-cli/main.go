// Command BluefinTecsMerchantPortal-cli is a CLI + REPL for the BluefinTecsMerchantPortal SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BLUEFIN_TECS_MERCHANT_PORTAL_APIKEY (api key), BLUEFIN_TECS_MERCHANT_PORTAL_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: BLUEFIN_TECS_MERCHANT_PORTAL_APIKEY carries the API key and
	// BLUEFIN_TECS_MERCHANT_PORTAL_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("BLUEFIN_TECS_MERCHANT_PORTAL_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("BLUEFIN_TECS_MERCHANT_PORTAL_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewBluefinTecsMerchantPortalSDK(opts)
