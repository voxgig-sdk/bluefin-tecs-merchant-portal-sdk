// merchant_portal_common_controller direct API test (generated from the API model).

import XCTest

@testable import BluefinTecsMerchantPortalSdk

final class MerchantPortalCommonControllerDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinTecsMerchantPortalSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/merchant_portal_common_controller")
