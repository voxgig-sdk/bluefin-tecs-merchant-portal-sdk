...
├── Sources/BluefinTecsMerchantPortalSdk/
...
└── Tests/BluefinTecsMerchantPortalSdkTests/    -- Test suites (XCTest)
```

The main client class (`BluefinTecsMerchantPortalSDK`, under `Sources/BluefinTecsMerchantPortalSdk/core`)
