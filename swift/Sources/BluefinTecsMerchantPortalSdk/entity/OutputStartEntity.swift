...
public final class OutputStartEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_start")
  }

  public override func make() -> Entity {
    return OutputStartEntity(client, cloneOpts())
  }
