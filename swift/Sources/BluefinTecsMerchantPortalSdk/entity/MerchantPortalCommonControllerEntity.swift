...
public final class MerchantPortalCommonControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_common_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalCommonControllerEntity(client, cloneOpts())
  }
