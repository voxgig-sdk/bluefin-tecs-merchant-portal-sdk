...
public final class OutputUpdateProductEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_update_product")
  }

  public override func make() -> Entity {
    return OutputUpdateProductEntity(client, cloneOpts())
  }
