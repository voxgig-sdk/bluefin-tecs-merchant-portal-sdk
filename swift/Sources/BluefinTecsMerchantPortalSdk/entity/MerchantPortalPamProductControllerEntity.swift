...
public final class MerchantPortalPamProductControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_pam_product_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalPamProductControllerEntity(client, cloneOpts())
  }
