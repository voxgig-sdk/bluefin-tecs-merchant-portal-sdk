...
public final class MerchantPortalPamContractControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_pam_contract_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalPamContractControllerEntity(client, cloneOpts())
  }
