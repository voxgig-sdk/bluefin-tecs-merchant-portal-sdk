// BluefinTecsMerchantPortal SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinTecsMerchantPortalError unless the per-call ctrl
...
func makeErrorUtil(_ ctx: Context, _ err: Error?) throws -> Value {
  ...
  var msg = "BluefinTecsMerchantPortalSDK: " + opname + ": " + errmsg
  ...
  let code = (e as? BluefinTecsMerchantPortalError)?.code ?? ""
  let sdkErr = BluefinTecsMerchantPortalError(code, msg, ctx)
