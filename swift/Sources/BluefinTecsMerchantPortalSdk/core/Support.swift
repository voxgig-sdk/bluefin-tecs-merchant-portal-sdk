// BluefinTecsMerchantPortal SDK - shared value helpers for the loose object model.
//
...
// does not define.
func unsupportedOp(_ opname: String, _ entityname: String) -> BluefinTecsMerchantPortalError {
...
func errMessage(_ e: Error) -> String {
  if let se = e as? BluefinTecsMerchantPortalError { return se.message }
