// BluefinTecsMerchantPortalEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinTecsMerchantPortalEntityBase: Entity {
  var name: String
  var client: BluefinTecsMerchantPortalSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinTecsMerchantPortalEntityBase(client, cloneOpts(), name)
  }
