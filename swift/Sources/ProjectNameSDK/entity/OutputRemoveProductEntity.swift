...
public final class OutputRemoveProductEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_remove_product")
  }

  public override func make() -> Entity {
    return OutputRemoveProductEntity(client, cloneOpts())
  }
