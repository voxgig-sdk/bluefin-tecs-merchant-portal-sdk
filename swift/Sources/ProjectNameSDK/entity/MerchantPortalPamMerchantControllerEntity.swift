...
public final class MerchantPortalPamMerchantControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_pam_merchant_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalPamMerchantControllerEntity(client, cloneOpts())
  }
