...
public final class MerchantPortalPamDocumentControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_pam_document_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalPamDocumentControllerEntity(client, cloneOpts())
  }
