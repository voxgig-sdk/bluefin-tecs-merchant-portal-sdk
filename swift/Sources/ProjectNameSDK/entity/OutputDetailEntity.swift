...
public final class OutputDetailEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_detail")
  }

  public override func make() -> Entity {
    return OutputDetailEntity(client, cloneOpts())
  }
