...
public final class OutputMessageEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_message")
  }

  public override func make() -> Entity {
    return OutputMessageEntity(client, cloneOpts())
  }
