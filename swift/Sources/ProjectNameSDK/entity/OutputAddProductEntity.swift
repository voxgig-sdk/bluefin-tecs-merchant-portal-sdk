...
public final class OutputAddProductEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_add_product")
  }

  public override func make() -> Entity {
    return OutputAddProductEntity(client, cloneOpts())
  }
