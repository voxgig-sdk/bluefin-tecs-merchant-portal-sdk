...
public final class OutputCreateProductEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_create_product")
  }

  public override func make() -> Entity {
    return OutputCreateProductEntity(client, cloneOpts())
  }
