...
public final class MerchantPortalPamPackageControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_pam_package_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalPamPackageControllerEntity(client, cloneOpts())
  }
