...
public final class OutputMoveTidEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_move_tid")
  }

  public override func make() -> Entity {
    return OutputMoveTidEntity(client, cloneOpts())
  }
