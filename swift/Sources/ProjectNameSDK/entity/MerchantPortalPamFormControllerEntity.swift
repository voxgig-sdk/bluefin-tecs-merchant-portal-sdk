...
public final class MerchantPortalPamFormControllerEntity: BluefinTecsMerchantPortalEntityBase {
  public init(_ client: BluefinTecsMerchantPortalSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "merchant_portal_pam_form_controller")
  }

  public override func make() -> Entity {
    return MerchantPortalPamFormControllerEntity(client, cloneOpts())
  }
