...
(ns sdk.entity.merchant_portal_pam_product_controller
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "merchant_portal_pam_product_controller" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "merchant_portal_pam_product_controller")
...
;; Canonical facade: (MerchantPortalPamProductController client data) accessor delegates here.
...
;; Create a new MerchantPortalPamProductController (reqdata: body data).
