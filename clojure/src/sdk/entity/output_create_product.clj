...
(ns sdk.entity.output_create_product
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_create_product" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_create_product")
...
;; Canonical facade: (OutputCreateProduct client data) accessor delegates here.
...
;; Create a new OutputCreateProduct (reqdata: body data).
