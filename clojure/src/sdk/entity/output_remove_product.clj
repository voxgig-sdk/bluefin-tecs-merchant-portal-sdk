...
(ns sdk.entity.output_remove_product
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_remove_product" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_remove_product")
...
;; Canonical facade: (OutputRemoveProduct client data) accessor delegates here.
...
;; Create a new OutputRemoveProduct (reqdata: body data).
