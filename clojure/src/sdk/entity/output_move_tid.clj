...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_move_tid" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_move_tid")
...
;; Canonical facade: (OutputMoveTid client data) accessor delegates here.
...
;; Create a new OutputMoveTid (reqdata: body data).
