...
(ns sdk.entity.merchant_portal_pam_mandator_controller
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "merchant_portal_pam_mandator_controller" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "merchant_portal_pam_mandator_controller")
...
;; Canonical facade: (MerchantPortalPamMandatorController client data) accessor delegates here.
...
;; Create a new MerchantPortalPamMandatorController (reqdata: body data).
