;; BluefinTecsMerchantPortal SDK MerchantPortalCommonController entity (generated by @voxgig/sdkgen).
(ns sdk.entity.merchant_portal_common_controller
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "merchant_portal_common_controller" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "merchant_portal_common_controller")
...
;; Canonical facade: (MerchantPortalCommonController client data) accessor delegates here.
...
;; Load a single MerchantPortalCommonController (reqmatch: id/query fields; nil = empty match).
