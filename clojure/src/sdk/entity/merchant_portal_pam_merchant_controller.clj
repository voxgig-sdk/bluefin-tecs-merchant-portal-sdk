...
(ns sdk.entity.merchant_portal_pam_merchant_controller
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "merchant_portal_pam_merchant_controller" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "merchant_portal_pam_merchant_controller")
...
;; Canonical facade: (MerchantPortalPamMerchantController client data) accessor delegates here.
...
;; Create a new MerchantPortalPamMerchantController (reqdata: body data).
