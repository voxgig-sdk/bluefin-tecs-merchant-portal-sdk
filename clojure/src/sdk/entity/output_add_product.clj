...
(ns sdk.entity.output_add_product
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_add_product" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_add_product")
...
;; Canonical facade: (OutputAddProduct client data) accessor delegates here.
...
;; Create a new OutputAddProduct (reqdata: body data).
