;; BluefinTecsMerchantPortal SDK OutputMessage entity (generated by @voxgig/sdkgen).
(ns sdk.entity.output_message
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_message" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_message")
...
;; Canonical facade: (OutputMessage client data) accessor delegates here.
...
;; Load a single OutputMessage (reqmatch: id/query fields; nil = empty match).
