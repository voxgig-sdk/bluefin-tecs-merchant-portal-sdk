...
(ns sdk.entity.merchant_portal_pam_document_controller
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "merchant_portal_pam_document_controller" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "merchant_portal_pam_document_controller")
...
;; Canonical facade: (MerchantPortalPamDocumentController client data) accessor delegates here.
...
;; Create a new MerchantPortalPamDocumentController (reqdata: body data).
