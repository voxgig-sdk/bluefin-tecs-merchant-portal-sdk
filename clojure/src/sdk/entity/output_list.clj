;; BluefinTecsMerchantPortal SDK OutputList entity (generated by @voxgig/sdkgen).
(ns sdk.entity.output_list
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_list" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_list")
...
;; Canonical facade: (OutputList client data) accessor delegates here.
...
;; Create a new OutputList (reqdata: body data).
