;; BluefinTecsMerchantPortal SDK OutputStatus entity (generated by @voxgig/sdkgen).
(ns sdk.entity.output_status
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_status" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_status")
...
;; Canonical facade: (OutputStatus client data) accessor delegates here.
...
;; Load a single OutputStatus (reqmatch: id/query fields; nil = empty match).
