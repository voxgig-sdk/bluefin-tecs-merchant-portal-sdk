;; BluefinTecsMerchantPortal SDK OutputDetail entity (generated by @voxgig/sdkgen).
(ns sdk.entity.output_detail
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_detail" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_detail")
...
;; Canonical facade: (OutputDetail client data) accessor delegates here.
...
;; Load a single OutputDetail (reqmatch: id/query fields; nil = empty match).
