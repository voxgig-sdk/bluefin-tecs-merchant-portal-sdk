;; BluefinTecsMerchantPortal SDK OutputStart entity (generated by @voxgig/sdkgen).
(ns sdk.entity.output_start
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_start" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_start")
...
;; Canonical facade: (OutputStart client data) accessor delegates here.
...
;; Create a new OutputStart (reqdata: body data).
