...
public class MerchantPortalPamMerchantControllerEntity extends EntityBase {

  public MerchantPortalPamMerchantControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_merchant_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamMerchantControllerEntity(this.client, opts);
  }
