...
public class OutputUpdateProductEntity extends EntityBase {

  public OutputUpdateProductEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_update_product", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputUpdateProductEntity(this.client, opts);
  }
