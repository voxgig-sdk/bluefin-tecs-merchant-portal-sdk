...
public class OutputStartEntity extends EntityBase {

  public OutputStartEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_start", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputStartEntity(this.client, opts);
  }
