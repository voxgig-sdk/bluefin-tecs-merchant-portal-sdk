...
public class MerchantPortalPamMandatorControllerEntity extends EntityBase {

  public MerchantPortalPamMandatorControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_mandator_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamMandatorControllerEntity(this.client, opts);
  }
