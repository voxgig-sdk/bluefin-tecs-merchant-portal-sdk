...
public class OutputCreateProductEntity extends EntityBase {

  public OutputCreateProductEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_create_product", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputCreateProductEntity(this.client, opts);
  }
