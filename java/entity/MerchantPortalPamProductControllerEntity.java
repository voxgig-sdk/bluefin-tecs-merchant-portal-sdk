...
public class MerchantPortalPamProductControllerEntity extends EntityBase {

  public MerchantPortalPamProductControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_product_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamProductControllerEntity(this.client, opts);
  }
