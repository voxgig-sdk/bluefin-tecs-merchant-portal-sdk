...
public class OutputAddProductEntity extends EntityBase {

  public OutputAddProductEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_add_product", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputAddProductEntity(this.client, opts);
  }
