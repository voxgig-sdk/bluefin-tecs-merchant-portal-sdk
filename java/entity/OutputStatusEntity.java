...
public class OutputStatusEntity extends EntityBase {

  public OutputStatusEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_status", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputStatusEntity(this.client, opts);
  }
