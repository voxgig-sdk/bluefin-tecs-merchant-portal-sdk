...
public class OutputListEntity extends EntityBase {

  public OutputListEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListEntity(this.client, opts);
  }
