...
public class MerchantPortalPamFormControllerEntity extends EntityBase {

  public MerchantPortalPamFormControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_form_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamFormControllerEntity(this.client, opts);
  }
