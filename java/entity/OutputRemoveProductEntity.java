...
public class OutputRemoveProductEntity extends EntityBase {

  public OutputRemoveProductEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_remove_product", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputRemoveProductEntity(this.client, opts);
  }
