...
public class OutputMoveTidEntity extends EntityBase {

  public OutputMoveTidEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_move_tid", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputMoveTidEntity(this.client, opts);
  }
