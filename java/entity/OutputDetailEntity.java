...
public class OutputDetailEntity extends EntityBase {

  public OutputDetailEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_detail", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputDetailEntity(this.client, opts);
  }
