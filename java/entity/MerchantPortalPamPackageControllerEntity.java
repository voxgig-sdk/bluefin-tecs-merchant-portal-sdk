...
public class MerchantPortalPamPackageControllerEntity extends EntityBase {

  public MerchantPortalPamPackageControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_package_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamPackageControllerEntity(this.client, opts);
  }
