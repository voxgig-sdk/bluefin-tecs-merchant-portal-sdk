...
public class OutputMessageEntity extends EntityBase {

  public OutputMessageEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_message", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputMessageEntity(this.client, opts);
  }
