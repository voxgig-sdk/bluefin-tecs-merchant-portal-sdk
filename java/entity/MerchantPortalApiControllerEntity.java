...
public class MerchantPortalApiControllerEntity extends EntityBase {

  public MerchantPortalApiControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_api_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalApiControllerEntity(this.client, opts);
  }
