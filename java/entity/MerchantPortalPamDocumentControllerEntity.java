...
public class MerchantPortalPamDocumentControllerEntity extends EntityBase {

  public MerchantPortalPamDocumentControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_document_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamDocumentControllerEntity(this.client, opts);
  }
