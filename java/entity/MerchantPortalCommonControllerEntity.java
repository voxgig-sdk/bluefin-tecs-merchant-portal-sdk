...
public class MerchantPortalCommonControllerEntity extends EntityBase {

  public MerchantPortalCommonControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_common_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalCommonControllerEntity(this.client, opts);
  }
