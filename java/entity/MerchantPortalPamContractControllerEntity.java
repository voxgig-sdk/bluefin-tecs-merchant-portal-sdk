...
public class MerchantPortalPamContractControllerEntity extends EntityBase {

  public MerchantPortalPamContractControllerEntity(SdkClient client, Map<String, Object> entopts) {
    super("merchant_portal_pam_contract_controller", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MerchantPortalPamContractControllerEntity(this.client, opts);
  }
