// Command BluefinTecsMerchantPortal-mcp is an MCP server exposing the BluefinTecsMerchantPortal
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinTecsMerchantPortal_list  — list records of an entity
//	BluefinTecsMerchantPortal_load  — load a single record of an entity
//
