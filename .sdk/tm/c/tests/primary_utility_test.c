...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsMerchantPortalSDK* live = projectname_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsMerchantPortalSDK* blocked = projectname_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsMerchantPortalSDK* client = projectname_sdk_new(v_undef());
