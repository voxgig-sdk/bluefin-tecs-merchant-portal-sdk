...
static Context* corpus_ctx(BluefinTecsMerchantPortalSDK* cl, voxgig_value* ctxmap) {
  CtxSpec cs;
...
static void runset(const char* name, BluefinTecsMerchantPortalSDK* cl,
                        ctxfn cf, argfn af) {
...
static BluefinTecsMerchantPortalSDK* SHARED = NULL;
...
static BluefinTecsMerchantPortalSDK* client_for(const char* section) {
