# BluefinTecsMerchantPortal SDK struct corpus test
#
...
defmodule BluefinTecsMerchantPortal.StructCorpusTest do
  use ExUnit.Case
  ...
  setup_all do
    ...
    runner = O.make_runner(testfile, BluefinTecsMerchantPortal.test())
