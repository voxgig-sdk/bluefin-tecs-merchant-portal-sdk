# BluefinTecsMerchantPortal SDK core runtime objects.
#
...
defmodule BluefinTecsMerchantPortal.Control do
...
defmodule BluefinTecsMerchantPortal.Spec do
  alias Voxgig.Struct, as: S
...
defmodule BluefinTecsMerchantPortal.Result do
  alias Voxgig.Struct, as: S
...
defmodule BluefinTecsMerchantPortal.Response do
  alias Voxgig.Struct, as: S
...
defmodule BluefinTecsMerchantPortal.Operation do
  alias Voxgig.Struct, as: S
