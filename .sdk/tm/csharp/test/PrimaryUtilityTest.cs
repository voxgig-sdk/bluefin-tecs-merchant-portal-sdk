...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = BluefinTecsMerchantPortalSDK.TestSDK(null, null);
    ...
    private static BluefinTecsMerchantPortalSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(BluefinTecsMerchantPortalSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(BluefinTecsMerchantPortalSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinTecsMerchantPortalSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinTecsMerchantPortalSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinTecsMerchantPortalSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinTecsMerchantPortalSDK.TestSDK(null, setupOpts);
    ...
    // BluefinTecsMerchantPortalError. The corpus says `match: out: code` for both, so
    ...
    public void MakePointBasic()
    {
        runsection("makePoint", args =>
        {
            ...
            catch (BluefinTecsMerchantPortalError e)
            {
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinTecsMerchantPortalSDK.TestSDK(null, setupOpts);
