...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinTecsMerchantPortalSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinTecsMerchantPortalSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinTecsMerchantPortalSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinTecsMerchantPortalSDK client, Utility utility)
    {
