// BluefinTecsMerchantPortal SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
public static class TestRunner
{
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinTecsMerchantPortalSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
        ...
        BluefinTecsMerchantPortalSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinTecsMerchantPortalError("", msg, null);
            }
        }
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinTecsMerchantPortalError(code, msg, null);
    }
