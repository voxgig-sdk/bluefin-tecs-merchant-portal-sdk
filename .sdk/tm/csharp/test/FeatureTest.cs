...
internal static class Fh
{
    ...
    {
        return err is BluefinTecsMerchantPortalError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinTecsMerchantPortalSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinTecsMerchantPortalSdk.Helpers.ToInt(paging["totalCount"]));
