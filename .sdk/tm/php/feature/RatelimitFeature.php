...
// BluefinTecsMerchantPortal SDK ratelimit feature
...
class BluefinTecsMerchantPortalRatelimitFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _acquire(BluefinTecsMerchantPortalContext $ctx): void
    {
    ...
    private function _track(BluefinTecsMerchantPortalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
