...
class BluefinTecsMerchantPortalMetricsFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _record(BluefinTecsMerchantPortalContext $ctx, bool $ok): void
    {
