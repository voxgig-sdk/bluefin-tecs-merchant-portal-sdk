...
class BluefinTecsMerchantPortalTelemetryFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _close(BluefinTecsMerchantPortalContext $ctx, bool $ok): void
    {
