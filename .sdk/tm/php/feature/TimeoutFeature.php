...
// BluefinTecsMerchantPortal SDK timeout feature
...
class BluefinTecsMerchantPortalTimeoutFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _with_timeout(BluefinTecsMerchantPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinTecsMerchantPortalContext $_ctx, float $ms): void
    {
        $client = $this->client;
