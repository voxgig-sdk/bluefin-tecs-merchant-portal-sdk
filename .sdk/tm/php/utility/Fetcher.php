...
class BluefinTecsMerchantPortalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinTecsMerchantPortalSDK/1.0)';
    ...
    public static function call(BluefinTecsMerchantPortalContext $ctx, string $fullurl, array $fetchdef): array
    {
