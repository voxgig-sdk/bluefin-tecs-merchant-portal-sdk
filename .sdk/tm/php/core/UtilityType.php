...
// BluefinTecsMerchantPortal SDK utility type

class BluefinTecsMerchantPortalUtility
{
    ...
    public static function copy(BluefinTecsMerchantPortalUtility $src): BluefinTecsMerchantPortalUtility
    {
        $u = new BluefinTecsMerchantPortalUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
