...
// The full CRUD entity contract of the BluefinTecsMerchantPortal SDK. Every generated
...
// A BluefinTecsMerchantPortal SDK feature. Hook methods are dispatched by name via the
