# BluefinTecsMerchantPortal SDK proxy feature
#
...
package BluefinTecsMerchantPortalProxyFeature;
...
sub init {
  ...
  if (BluefinTecsMerchantPortalHelpers::is_true($self->{options}{fromEnv})) {
    $self->{url} = $self->{url}
