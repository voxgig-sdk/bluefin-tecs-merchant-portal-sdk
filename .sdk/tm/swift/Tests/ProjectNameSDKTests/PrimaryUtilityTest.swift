...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private static func primaryRun() throws -> OmniResolver.Run {
    ...
    let run = try OmniResolver.makeRunner(
      SdkRunner.testJsonPath(), BluefinTecsMerchantPortalSDK.testSDK(nil, nil))("primary")
    RUN = run
    return run
  }

  // XCTestCase has no custom init; set these up per test.
  private var client: BluefinTecsMerchantPortalSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    client = BluefinTecsMerchantPortalSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinTecsMerchantPortalSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinTecsMerchantPortalSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinTecsMerchantPortalSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinTecsMerchantPortalSDK.testSDK(nil, nil)
  ...
  func testExtendOptionInstallsAndInitialisesTheFeature() {
    ...
    let client = BluefinTecsMerchantPortalSDK.testSDK(nil, opts)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinTecsMerchantPortalSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinTecsMerchantPortalSDK(opts)
  ...
  func testMakeSpecBasic() throws {
    ...
    let specClient = BluefinTecsMerchantPortalSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() throws {
    ...
    let authClient = BluefinTecsMerchantPortalSDK.testSDK(nil, setupOpts)
