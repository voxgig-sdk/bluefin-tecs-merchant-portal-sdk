// Shared Value helpers for the BluefinTecsMerchantPortal SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinTecsMerchantPortalEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinTecsMerchantPortalError {
    BluefinTecsMerchantPortalError::new(
        "unsupported_op",
        &format!(
