...
|---|---|---|
| `js/` | @voxgig-sdk/bluefin-tecs-merchant-portal-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bluefin-tecs-merchant-portal | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bluefin-tecs-merchant-portal-js \
      --repository voxgig-sdk/bluefin-tecs-merchant-portal-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bluefin-tecs-merchant-portal-js` shows it, and
`npm trust revoke @voxgig-sdk/bluefin-tecs-merchant-portal-js --id=<id>` removes it.
