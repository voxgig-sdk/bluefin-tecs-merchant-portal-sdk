...
class OutputUpdateProductEntity
  ...
  def make
    opts = @_entopts.dup
    OutputUpdateProductEntity.new(@_client, opts)
  end
  ...
  # @return [OutputUpdateProduct, Hash] the current OutputUpdateProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputUpdateProduct fields)
  def match_get
  ...
  #
  # @param reqdata [OutputUpdateProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputUpdateProduct, Hash] the created OutputUpdateProduct; raises BluefinTecsMerchantPortalError on failure
