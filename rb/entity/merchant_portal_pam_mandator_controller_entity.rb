...
class MerchantPortalPamMandatorControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamMandatorControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamMandatorController, Hash] the current MerchantPortalPamMandatorController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamMandatorController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamMandatorControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamMandatorController, Hash] the created MerchantPortalPamMandatorController; raises BluefinTecsMerchantPortalError on failure
