...
class MerchantPortalPamProductControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamProductControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamProductController, Hash] the current MerchantPortalPamProductController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamProductController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamProductControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamProductController, Hash] the created MerchantPortalPamProductController; raises BluefinTecsMerchantPortalError on failure
