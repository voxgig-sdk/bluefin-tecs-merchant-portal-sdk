...
class MerchantPortalPamMerchantControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamMerchantControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamMerchantController, Hash] the current MerchantPortalPamMerchantController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamMerchantController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamMerchantControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamMerchantController, Hash] the created MerchantPortalPamMerchantController; raises BluefinTecsMerchantPortalError on failure
