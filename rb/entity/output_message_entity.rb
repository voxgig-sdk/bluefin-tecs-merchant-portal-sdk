...
class OutputMessageEntity
  ...
  def make
    opts = @_entopts.dup
    OutputMessageEntity.new(@_client, opts)
  end
  ...
  # @return [OutputMessage, Hash] the current OutputMessage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputMessage fields)
  def match_get
  ...
  #
  # @param reqmatch [OutputMessageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OutputMessage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputMessage, Hash] the loaded OutputMessage; raises BluefinTecsMerchantPortalError on failure
