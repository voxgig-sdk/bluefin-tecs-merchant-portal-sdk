...
class OutputStatusEntity
  ...
  def make
    opts = @_entopts.dup
    OutputStatusEntity.new(@_client, opts)
  end
  ...
  # @return [OutputStatus, Hash] the current OutputStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [OutputStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OutputStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputStatus, Hash] the loaded OutputStatus; raises BluefinTecsMerchantPortalError on failure
