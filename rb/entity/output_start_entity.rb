...
class OutputStartEntity
  ...
  def make
    opts = @_entopts.dup
    OutputStartEntity.new(@_client, opts)
  end
  ...
  # @return [OutputStart, Hash] the current OutputStart data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputStart fields)
  def match_get
  ...
  #
  # @param reqdata [OutputStartCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputStart, Hash] the created OutputStart; raises BluefinTecsMerchantPortalError on failure
