...
class OutputListEntity
  ...
  def make
    opts = @_entopts.dup
    OutputListEntity.new(@_client, opts)
  end
  ...
  # @return [OutputList, Hash] the current OutputList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputList fields)
  def match_get
  ...
  #
  # @param reqdata [OutputListCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputList, Hash] the created OutputList; raises BluefinTecsMerchantPortalError on failure
