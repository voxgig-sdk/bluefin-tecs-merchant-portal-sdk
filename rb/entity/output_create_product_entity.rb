...
class OutputCreateProductEntity
  ...
  def make
    opts = @_entopts.dup
    OutputCreateProductEntity.new(@_client, opts)
  end
  ...
  # @return [OutputCreateProduct, Hash] the current OutputCreateProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputCreateProduct fields)
  def match_get
  ...
  #
  # @param reqdata [OutputCreateProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputCreateProduct, Hash] the created OutputCreateProduct; raises BluefinTecsMerchantPortalError on failure
