...
class MerchantPortalPamFormControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamFormControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamFormController, Hash] the current MerchantPortalPamFormController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamFormController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamFormControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamFormController, Hash] the created MerchantPortalPamFormController; raises BluefinTecsMerchantPortalError on failure
