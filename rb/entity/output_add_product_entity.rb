...
class OutputAddProductEntity
  ...
  def make
    opts = @_entopts.dup
    OutputAddProductEntity.new(@_client, opts)
  end
  ...
  # @return [OutputAddProduct, Hash] the current OutputAddProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputAddProduct fields)
  def match_get
  ...
  #
  # @param reqdata [OutputAddProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputAddProduct, Hash] the created OutputAddProduct; raises BluefinTecsMerchantPortalError on failure
