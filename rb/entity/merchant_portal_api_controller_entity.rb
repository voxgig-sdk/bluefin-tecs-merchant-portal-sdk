...
class MerchantPortalApiControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalApiControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalApiController, Hash] the current MerchantPortalApiController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalApiController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalApiControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalApiController, Hash] the created MerchantPortalApiController; raises BluefinTecsMerchantPortalError on failure
