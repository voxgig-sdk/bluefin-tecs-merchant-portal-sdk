...
class OutputMoveTidEntity
  ...
  def make
    opts = @_entopts.dup
    OutputMoveTidEntity.new(@_client, opts)
  end
  ...
  # @return [OutputMoveTid, Hash] the current OutputMoveTid data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputMoveTid fields)
  def match_get
  ...
  #
  # @param reqdata [OutputMoveTidCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputMoveTid, Hash] the created OutputMoveTid; raises BluefinTecsMerchantPortalError on failure
