...
class OutputDetailEntity
  ...
  def make
    opts = @_entopts.dup
    OutputDetailEntity.new(@_client, opts)
  end
  ...
  # @return [OutputDetail, Hash] the current OutputDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [OutputDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OutputDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputDetail, Hash] the loaded OutputDetail; raises BluefinTecsMerchantPortalError on failure
