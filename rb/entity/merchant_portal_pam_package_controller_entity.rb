...
class MerchantPortalPamPackageControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamPackageControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamPackageController, Hash] the current MerchantPortalPamPackageController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamPackageController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamPackageControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamPackageController, Hash] the created MerchantPortalPamPackageController; raises BluefinTecsMerchantPortalError on failure
