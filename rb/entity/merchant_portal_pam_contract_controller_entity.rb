...
class MerchantPortalPamContractControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamContractControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamContractController, Hash] the current MerchantPortalPamContractController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamContractController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamContractControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamContractController, Hash] the created MerchantPortalPamContractController; raises BluefinTecsMerchantPortalError on failure
