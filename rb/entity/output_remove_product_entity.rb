...
class OutputRemoveProductEntity
  ...
  def make
    opts = @_entopts.dup
    OutputRemoveProductEntity.new(@_client, opts)
  end
  ...
  # @return [OutputRemoveProduct, Hash] the current OutputRemoveProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputRemoveProduct fields)
  def match_get
  ...
  #
  # @param reqdata [OutputRemoveProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputRemoveProduct, Hash] the created OutputRemoveProduct; raises BluefinTecsMerchantPortalError on failure
