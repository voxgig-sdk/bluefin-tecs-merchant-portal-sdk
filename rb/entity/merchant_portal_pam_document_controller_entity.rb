...
class MerchantPortalPamDocumentControllerEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantPortalPamDocumentControllerEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPortalPamDocumentController, Hash] the current MerchantPortalPamDocumentController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPortalPamDocumentController fields)
  def match_get
  ...
  #
  # @param reqdata [MerchantPortalPamDocumentControllerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPortalPamDocumentController, Hash] the created MerchantPortalPamDocumentController; raises BluefinTecsMerchantPortalError on failure
