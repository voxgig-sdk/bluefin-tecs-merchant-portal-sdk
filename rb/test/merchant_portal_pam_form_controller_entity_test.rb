...
class MerchantPortalPamFormControllerEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSMERCHANTPORTAL_TEST_MERCHANT_PORTAL_PAM_FORM_CONTROLLER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def merchant_portal_pam_form_controller_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSMERCHANTPORTAL_TEST_MERCHANT_PORTAL_PAM_FORM_CONTROLLER_ENTID"]
