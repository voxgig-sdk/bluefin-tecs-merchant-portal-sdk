...
#      offline in seeded test mode (BluefinTecsMerchantPortalSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinTecsMerchantPortal_sdk.rb")
  SDK_CLASS = "BluefinTecsMerchantPortalSDK"
  ...
  SDK_BASE = "BluefinTecsMerchantPortal_sdk"
