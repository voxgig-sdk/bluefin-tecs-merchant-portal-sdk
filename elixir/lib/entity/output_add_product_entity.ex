...
defmodule BluefinTecsMerchantPortal.Entity.OutputAddProduct do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_add_product", entopts)
  end
  ...
  # Returns the created output_add_product entity map (BluefinTecsMerchantPortal.Types.output_add_product/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.output_add_product_create_data() | nil, map() | nil) :: term()
