...
defmodule BluefinTecsMerchantPortal.Entity.MerchantPortalApiController do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_api_controller", entopts)
  end
  ...
  # Returns the created merchant_portal_api_controller entity map (BluefinTecsMerchantPortal.Types.merchant_portal_api_controller/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.merchant_portal_api_controller_create_data() | nil, map() | nil) :: term()
