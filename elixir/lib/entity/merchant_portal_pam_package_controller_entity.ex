...
defmodule BluefinTecsMerchantPortal.Entity.MerchantPortalPamPackageController do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_pam_package_controller", entopts)
  end
  ...
  # Returns the created merchant_portal_pam_package_controller entity map (BluefinTecsMerchantPortal.Types.merchant_portal_pam_package_controller/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.merchant_portal_pam_package_controller_create_data() | nil, map() | nil) :: term()
