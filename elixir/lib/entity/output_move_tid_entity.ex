...
defmodule BluefinTecsMerchantPortal.Entity.OutputMoveTid do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_move_tid", entopts)
  end
  ...
  # Returns the created output_move_tid entity map (BluefinTecsMerchantPortal.Types.output_move_tid/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.output_move_tid_create_data() | nil, map() | nil) :: term()
