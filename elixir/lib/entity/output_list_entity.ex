...
defmodule BluefinTecsMerchantPortal.Entity.OutputList do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list", entopts)
  end
  ...
  # Returns the created output_list entity map (BluefinTecsMerchantPortal.Types.output_list/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.output_list_create_data() | nil, map() | nil) :: term()
