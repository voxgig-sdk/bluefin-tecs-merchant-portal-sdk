...
# and drives it through BluefinTecsMerchantPortal.Pipeline.run_op.

defmodule BluefinTecsMerchantPortal.Entity.MerchantPortalPamMerchantController do
  alias Voxgig.Struct, as: S
  alias BluefinTecsMerchantPortal.Helpers, as: H
  alias BluefinTecsMerchantPortal.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_pam_merchant_controller", entopts)
  end
  ...
  # Returns the created merchant_portal_pam_merchant_controller entity map (BluefinTecsMerchantPortal.Types.merchant_portal_pam_merchant_controller/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.merchant_portal_pam_merchant_controller_create_data() | nil, map() | nil) :: term()
