...
defmodule BluefinTecsMerchantPortal.Entity.OutputStatus do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_status", entopts)
  end
  ...
  # Returns the output_status entity map (BluefinTecsMerchantPortal.Types.output_status/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsMerchantPortal.Types.output_status_load_match() | nil, map() | nil) :: term()
