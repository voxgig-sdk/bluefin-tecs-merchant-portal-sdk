...
defmodule BluefinTecsMerchantPortal.Entity.MerchantPortalCommonController do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_common_controller", entopts)
  end
  ...
  # Returns the merchant_portal_common_controller entity map (BluefinTecsMerchantPortal.Types.merchant_portal_common_controller/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsMerchantPortal.Types.merchant_portal_common_controller_load_match() | nil, map() | nil) :: term()
