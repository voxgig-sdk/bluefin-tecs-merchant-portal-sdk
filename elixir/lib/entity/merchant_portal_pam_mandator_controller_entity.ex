...
defmodule BluefinTecsMerchantPortal.Entity.MerchantPortalPamMandatorController do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_pam_mandator_controller", entopts)
  end
  ...
  # Returns the created merchant_portal_pam_mandator_controller entity map (BluefinTecsMerchantPortal.Types.merchant_portal_pam_mandator_controller/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.merchant_portal_pam_mandator_controller_create_data() | nil, map() | nil) :: term()
