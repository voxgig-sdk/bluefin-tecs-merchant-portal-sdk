...
defmodule BluefinTecsMerchantPortal.Entity.OutputDetail do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_detail", entopts)
  end
  ...
  # Returns the output_detail entity map (BluefinTecsMerchantPortal.Types.output_detail/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsMerchantPortal.Types.output_detail_load_match() | nil, map() | nil) :: term()
