...
defmodule BluefinTecsMerchantPortal.Entity.MerchantPortalPamProductController do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "merchant_portal_pam_product_controller", entopts)
  end
  ...
  # Returns the created merchant_portal_pam_product_controller entity map (BluefinTecsMerchantPortal.Types.merchant_portal_pam_product_controller/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.merchant_portal_pam_product_controller_create_data() | nil, map() | nil) :: term()
