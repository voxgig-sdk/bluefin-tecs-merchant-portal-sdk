...
defmodule BluefinTecsMerchantPortal.Entity.OutputCreateProduct do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_create_product", entopts)
  end
  ...
  # Returns the created output_create_product entity map (BluefinTecsMerchantPortal.Types.output_create_product/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.output_create_product_create_data() | nil, map() | nil) :: term()
