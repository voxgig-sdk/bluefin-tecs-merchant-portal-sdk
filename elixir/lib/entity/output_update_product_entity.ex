...
defmodule BluefinTecsMerchantPortal.Entity.OutputUpdateProduct do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_update_product", entopts)
  end
  ...
  # Returns the created output_update_product entity map (BluefinTecsMerchantPortal.Types.output_update_product/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.output_update_product_create_data() | nil, map() | nil) :: term()
