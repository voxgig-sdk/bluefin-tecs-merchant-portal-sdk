...
defmodule BluefinTecsMerchantPortal.Entity.OutputRemoveProduct do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_remove_product", entopts)
  end
  ...
  # Returns the created output_remove_product entity map (BluefinTecsMerchantPortal.Types.output_remove_product/0)
  ...
  @spec create(map(), BluefinTecsMerchantPortal.Types.output_remove_product_create_data() | nil, map() | nil) :: term()
