...
defmodule BluefinTecsMerchantPortal.Feature.Clienttrack do
  alias Voxgig.Struct, as: S
  alias BluefinTecsMerchantPortal.Feature
  ...
  defp name(f) do
    opts = Feature.opts(f)
    n = por(S.getprop(opts, "clientName"), "BluefinTecsMerchantPortal-SDK")
