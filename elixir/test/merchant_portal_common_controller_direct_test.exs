# MerchantPortalCommonController direct test (offline, mock system.fetch)

defmodule BluefinTecsMerchantPortal.MerchantPortalCommonControllerDirectTest do
  use ExUnit.Case
  ...
  test "should direct load merchant_portal_common_controller" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinTecsMerchantPortal.direct(sdk, H.deep(%{"path" => "/merchant_portal_common_controller/direct01", "method" => "GET", "params" => %{}}))
