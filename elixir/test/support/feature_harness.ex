...
defmodule BluefinTecsMerchantPortal.FeatureHarness do
  alias Voxgig.Struct, as: S
  alias BluefinTecsMerchantPortal.Helpers, as: H
  alias BluefinTecsMerchantPortal.{Control, Spec, Result, Context, Features}

  # True when this SDK was generated with the named feature.
  def has_feature(name) do
    feature = S.getprop(BluefinTecsMerchantPortal.Config.make_config(), "feature")
