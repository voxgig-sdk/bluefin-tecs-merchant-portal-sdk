# BluefinTecsMerchantPortal SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/BluefinTecsMerchantPortalSDKTests/OmniResolver.swift.
#
...
defmodule BluefinTecsMerchantPortal.Omni do
  ...
  defp sdkprovider(client) do
    utility = BluefinTecsMerchantPortal.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(BluefinTecsMerchantPortal.test(nil, tostruct(options))) end,
  ...
  def errify(%BluefinTecsMerchantPortal.Error{} = err) do
