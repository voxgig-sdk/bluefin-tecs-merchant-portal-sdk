# BluefinTecsMerchantPortal SDK omni runner smoke test
#
...
defmodule BluefinTecsMerchantPortal.OmniSmokeTest do
  use ExUnit.Case
  ...
  defp pack do
    runner = O.make_runner(@spec_smoke, BluefinTecsMerchantPortal.test())
    runner.("smoke")
  end
