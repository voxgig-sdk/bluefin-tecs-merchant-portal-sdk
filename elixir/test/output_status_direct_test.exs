# OutputStatus direct test (offline, mock system.fetch)

defmodule BluefinTecsMerchantPortal.OutputStatusDirectTest do
  use ExUnit.Case
  ...
  test "should direct load output_status" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinTecsMerchantPortal.direct(sdk, H.deep(%{"path" => "/output_status/direct01", "method" => "GET", "params" => %{}}))
