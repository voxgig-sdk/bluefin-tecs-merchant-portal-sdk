# OutputMessage direct test (offline, mock system.fetch)

defmodule BluefinTecsMerchantPortal.OutputMessageDirectTest do
  use ExUnit.Case
  ...
  test "should direct load output_message" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinTecsMerchantPortal.direct(sdk, H.deep(%{"path" => "/output_message/direct01", "method" => "GET", "params" => %{}}))
