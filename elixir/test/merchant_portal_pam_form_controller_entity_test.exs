# MerchantPortalPamFormController entity test (offline, mock transport)

defmodule BluefinTecsMerchantPortal.MerchantPortalPamFormControllerEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/merchant_portal_pam_form_controller/MerchantPortalPamFormControllerTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.merchant_portal_pam_form_controller"), S.jm([]))
