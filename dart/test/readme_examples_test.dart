// BluefinTecsMerchantPortal SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'BluefinTecsMerchantPortalSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['MerchantPortalApiController', 'MerchantPortalCommonController', 'MerchantPortalPamContractController', 'MerchantPortalPamDocumentController', 'MerchantPortalPamFormController', 'MerchantPortalPamMandatorController', 'MerchantPortalPamMerchantController', 'MerchantPortalPamPackageController', 'MerchantPortalPamProductController', 'OutputAddProduct', 'OutputCreateProduct', 'OutputDetail', 'OutputList', 'OutputMessage', 'OutputMoveTid', 'OutputRemoveProduct', 'OutputStart', 'OutputStatus', 'OutputUpdateProduct'];
