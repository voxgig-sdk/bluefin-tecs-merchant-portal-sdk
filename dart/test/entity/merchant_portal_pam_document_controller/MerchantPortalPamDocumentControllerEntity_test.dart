...
void tests() {
  describe('MerchantPortalPamDocumentControllerEntity', () {
    test('instance', (t) async {
      final testsdk = BluefinTecsMerchantPortalSDK.test();
      final ent = testsdk.MerchantPortalPamDocumentController();
      ok(null != ent);
    });
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.MerchantPortalPamDocumentController();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'merchant_portal_pam_document_controller.' + op, live)) {
          return;
        }
      }
      ...
      // CREATE
      final merchant_portal_pam_document_controller_ref01_ent = client.MerchantPortalPamDocumentController();
      dynamic merchant_portal_pam_document_controller_ref01_data = setup['data']['new']['merchant_portal_pam_document_controller']['merchant_portal_pam_document_controller_ref01'];
      ...
      ok(null != merchant_portal_pam_document_controller_ref01_data);
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['merchant_portal_pam_document_controller01', 'merchant_portal_pam_document_controller02', 'merchant_portal_pam_document_controller03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_DOCUMENT_CONTROLLER_ENTID'];
