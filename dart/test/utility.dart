...
Map<String, dynamic> envOverride(Map<String, dynamic> m) {
  ...
  if ('TRUE' == env['BLUEFINTECSMERCHANTPORTAL_TEST_LIVE'] ||
      'TRUE' == env['BLUEFINTECSMERCHANTPORTAL_TEST_OVERRIDE']) {
  ...
  m['BLUEFINTECSMERCHANTPORTAL_TEST_EXPLAIN'] =
      env['BLUEFINTECSMERCHANTPORTAL_TEST_EXPLAIN'] ?? m['BLUEFINTECSMERCHANTPORTAL_TEST_EXPLAIN'];
