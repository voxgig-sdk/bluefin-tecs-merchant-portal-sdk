...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputUpdateProduct and the per-op request/match types).
class OutputUpdateProductEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputUpdateProductEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_update_product';
    name_ = 'output_update_product';
    Name = 'OutputUpdateProduct';
  }

  OutputUpdateProductEntity make() {
    return OutputUpdateProductEntity(client, entopts());
  }




  /// Create a OutputUpdateProduct (see OutputUpdateProductCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputUpdateProduct).
