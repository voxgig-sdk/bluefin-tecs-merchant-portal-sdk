...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputMoveTid and the per-op request/match types).
class OutputMoveTidEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputMoveTidEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_move_tid';
    name_ = 'output_move_tid';
    Name = 'OutputMoveTid';
  }

  OutputMoveTidEntity make() {
    return OutputMoveTidEntity(client, entopts());
  }




  /// Create a OutputMoveTid (see OutputMoveTidCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputMoveTid).
