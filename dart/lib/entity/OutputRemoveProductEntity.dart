...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputRemoveProduct and the per-op request/match types).
class OutputRemoveProductEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputRemoveProductEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_remove_product';
    name_ = 'output_remove_product';
    Name = 'OutputRemoveProduct';
  }

  OutputRemoveProductEntity make() {
    return OutputRemoveProductEntity(client, entopts());
  }




  /// Create a OutputRemoveProduct (see OutputRemoveProductCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputRemoveProduct).
