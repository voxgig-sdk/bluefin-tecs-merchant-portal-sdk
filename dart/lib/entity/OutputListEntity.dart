...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputList and the per-op request/match types).
class OutputListEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputListEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list';
    name_ = 'output_list';
    Name = 'OutputList';
  }

  OutputListEntity make() {
    return OutputListEntity(client, entopts());
  }




  /// Create a OutputList (see OutputListCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputList).
