...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputDetail and the per-op request/match types).
class OutputDetailEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputDetailEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_detail';
    name_ = 'output_detail';
    Name = 'OutputDetail';
  }

  OutputDetailEntity make() {
    return OutputDetailEntity(client, entopts());
  }


  /// Load a OutputDetail by match (see OutputDetailLoadMatch in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputDetail).
