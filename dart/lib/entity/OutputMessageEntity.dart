...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputMessage and the per-op request/match types).
class OutputMessageEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputMessageEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_message';
    name_ = 'output_message';
    Name = 'OutputMessage';
  }

  OutputMessageEntity make() {
    return OutputMessageEntity(client, entopts());
  }


  /// Load a OutputMessage by match (see OutputMessageLoadMatch in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputMessage).
