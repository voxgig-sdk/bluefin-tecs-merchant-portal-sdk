...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputStart and the per-op request/match types).
class OutputStartEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputStartEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_start';
    name_ = 'output_start';
    Name = 'OutputStart';
  }

  OutputStartEntity make() {
    return OutputStartEntity(client, entopts());
  }




  /// Create a OutputStart (see OutputStartCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputStart).
