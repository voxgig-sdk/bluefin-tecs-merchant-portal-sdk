...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputCreateProduct and the per-op request/match types).
class OutputCreateProductEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputCreateProductEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_create_product';
    name_ = 'output_create_product';
    Name = 'OutputCreateProduct';
  }

  OutputCreateProductEntity make() {
    return OutputCreateProductEntity(client, entopts());
  }




  /// Create a OutputCreateProduct (see OutputCreateProductCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputCreateProduct).
