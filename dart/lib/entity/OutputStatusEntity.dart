...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputStatus and the per-op request/match types).
class OutputStatusEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputStatusEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_status';
    name_ = 'output_status';
    Name = 'OutputStatus';
  }

  OutputStatusEntity make() {
    return OutputStatusEntity(client, entopts());
  }


  /// Load a OutputStatus by match (see OutputStatusLoadMatch in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputStatus).
