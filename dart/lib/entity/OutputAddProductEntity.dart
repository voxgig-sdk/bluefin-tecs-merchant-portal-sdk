...
// Typed models: see ../BluefinTecsMerchantPortalTypes.dart (OutputAddProduct and the per-op request/match types).
class OutputAddProductEntity extends BluefinTecsMerchantPortalEntityBase {
  OutputAddProductEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_add_product';
    name_ = 'output_add_product';
    Name = 'OutputAddProduct';
  }

  OutputAddProductEntity make() {
    return OutputAddProductEntity(client, entopts());
  }




  /// Create a OutputAddProduct (see OutputAddProductCreateData in
  /// BluefinTecsMerchantPortalTypes.dart). Returns the entity data map (OutputAddProduct).
