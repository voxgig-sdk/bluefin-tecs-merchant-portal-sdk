...
local OutputMessageEntity = {}
OutputMessageEntity.__index = OutputMessageEntity


function OutputMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputMessageEntity)
  self._name = "output_message"
  self._client = client
...
function OutputMessageEntity:get_name()
  return self._name
end


function OutputMessageEntity:make()
  local opts = {}
...
function OutputMessageEntity:mark_deleted()
  self._deleted = true
end


function OutputMessageEntity:deleted()
  return true == self._deleted
end


function OutputMessageEntity:data_set(args)
  if args ~= nil then
...
function OutputMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputMessageEntity:match_set(args)
  if args ~= nil then
...
function OutputMessageEntity:match_get()
...
function OutputMessageEntity:stream(action, args, callopts)
...
---@param reqmatch OutputMessageLoadMatch
---@param ctrl? table
---@return OutputMessage
---@return string? err
function OutputMessageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OutputMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
