...
local MerchantPortalApiControllerEntity = {}
MerchantPortalApiControllerEntity.__index = MerchantPortalApiControllerEntity


function MerchantPortalApiControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalApiControllerEntity)
  self._name = "merchant_portal_api_controller"
  self._client = client
...
function MerchantPortalApiControllerEntity:get_name()
  return self._name
end


function MerchantPortalApiControllerEntity:make()
  local opts = {}
...
function MerchantPortalApiControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalApiControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalApiControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalApiControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalApiControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalApiControllerEntity:match_get()
...
function MerchantPortalApiControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalApiControllerCreateData
---@param ctrl? table
---@return MerchantPortalApiController
---@return string? err
function MerchantPortalApiControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalApiControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalApiControllerEntity
