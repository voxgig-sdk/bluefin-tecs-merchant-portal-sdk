-- BluefinTecsMerchantPortal SDK MerchantPortalPamMerchantController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamMerchantControllerEntity = {}
MerchantPortalPamMerchantControllerEntity.__index = MerchantPortalPamMerchantControllerEntity


function MerchantPortalPamMerchantControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamMerchantControllerEntity)
  self._name = "merchant_portal_pam_merchant_controller"
  self._client = client
...
function MerchantPortalPamMerchantControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamMerchantControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamMerchantControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamMerchantControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamMerchantControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamMerchantControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamMerchantControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamMerchantControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamMerchantControllerEntity:match_get()
...
function MerchantPortalPamMerchantControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamMerchantControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamMerchantController
---@return string? err
function MerchantPortalPamMerchantControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamMerchantControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamMerchantControllerEntity
