...
local OutputStartEntity = {}
OutputStartEntity.__index = OutputStartEntity


function OutputStartEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputStartEntity)
  self._name = "output_start"
  self._client = client
...
function OutputStartEntity:get_name()
  return self._name
end


function OutputStartEntity:make()
  local opts = {}
...
function OutputStartEntity:mark_deleted()
  self._deleted = true
end


function OutputStartEntity:deleted()
  return true == self._deleted
end


function OutputStartEntity:data_set(args)
  if args ~= nil then
...
function OutputStartEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputStartEntity:match_set(args)
  if args ~= nil then
...
function OutputStartEntity:match_get()
...
function OutputStartEntity:stream(action, args, callopts)
...
---@param reqdata OutputStartCreateData
---@param ctrl? table
---@return OutputStart
---@return string? err
function OutputStartEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputStartEntity:_run_op(ctx, post_done)
  local utility = self._utility
