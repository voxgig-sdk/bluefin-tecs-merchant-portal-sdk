-- BluefinTecsMerchantPortal SDK MerchantPortalPamDocumentController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamDocumentControllerEntity = {}
MerchantPortalPamDocumentControllerEntity.__index = MerchantPortalPamDocumentControllerEntity


function MerchantPortalPamDocumentControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamDocumentControllerEntity)
  self._name = "merchant_portal_pam_document_controller"
  self._client = client
...
function MerchantPortalPamDocumentControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamDocumentControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamDocumentControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamDocumentControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamDocumentControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamDocumentControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamDocumentControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamDocumentControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamDocumentControllerEntity:match_get()
...
function MerchantPortalPamDocumentControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamDocumentControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamDocumentController
---@return string? err
function MerchantPortalPamDocumentControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamDocumentControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamDocumentControllerEntity
