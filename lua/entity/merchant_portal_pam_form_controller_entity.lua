-- BluefinTecsMerchantPortal SDK MerchantPortalPamFormController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamFormControllerEntity = {}
MerchantPortalPamFormControllerEntity.__index = MerchantPortalPamFormControllerEntity


function MerchantPortalPamFormControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamFormControllerEntity)
  self._name = "merchant_portal_pam_form_controller"
  self._client = client
...
function MerchantPortalPamFormControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamFormControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamFormControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamFormControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamFormControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamFormControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamFormControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamFormControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamFormControllerEntity:match_get()
...
function MerchantPortalPamFormControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamFormControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamFormController
---@return string? err
function MerchantPortalPamFormControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamFormControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamFormControllerEntity
