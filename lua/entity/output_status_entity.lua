...
local OutputStatusEntity = {}
OutputStatusEntity.__index = OutputStatusEntity


function OutputStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputStatusEntity)
  self._name = "output_status"
  self._client = client
...
function OutputStatusEntity:get_name()
  return self._name
end


function OutputStatusEntity:make()
  local opts = {}
...
function OutputStatusEntity:mark_deleted()
  self._deleted = true
end


function OutputStatusEntity:deleted()
  return true == self._deleted
end


function OutputStatusEntity:data_set(args)
  if args ~= nil then
...
function OutputStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputStatusEntity:match_set(args)
  if args ~= nil then
...
function OutputStatusEntity:match_get()
...
function OutputStatusEntity:stream(action, args, callopts)
...
---@param reqmatch OutputStatusLoadMatch
---@param ctrl? table
---@return OutputStatus
---@return string? err
function OutputStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OutputStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
