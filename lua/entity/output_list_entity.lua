...
local OutputListEntity = {}
OutputListEntity.__index = OutputListEntity


function OutputListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListEntity)
  self._name = "output_list"
  self._client = client
...
function OutputListEntity:get_name()
  return self._name
end


function OutputListEntity:make()
  local opts = {}
...
function OutputListEntity:mark_deleted()
  self._deleted = true
end


function OutputListEntity:deleted()
  return true == self._deleted
end


function OutputListEntity:data_set(args)
  if args ~= nil then
...
function OutputListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListEntity:match_set(args)
  if args ~= nil then
...
function OutputListEntity:match_get()
...
function OutputListEntity:stream(action, args, callopts)
...
---@param reqdata OutputListCreateData
---@param ctrl? table
---@return OutputList
---@return string? err
function OutputListEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListEntity:_run_op(ctx, post_done)
  local utility = self._utility
