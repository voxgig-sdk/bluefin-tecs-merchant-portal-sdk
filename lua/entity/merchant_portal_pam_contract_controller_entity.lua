-- BluefinTecsMerchantPortal SDK MerchantPortalPamContractController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamContractControllerEntity = {}
MerchantPortalPamContractControllerEntity.__index = MerchantPortalPamContractControllerEntity


function MerchantPortalPamContractControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamContractControllerEntity)
  self._name = "merchant_portal_pam_contract_controller"
  self._client = client
...
function MerchantPortalPamContractControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamContractControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamContractControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamContractControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamContractControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamContractControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamContractControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamContractControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamContractControllerEntity:match_get()
...
function MerchantPortalPamContractControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamContractControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamContractController
---@return string? err
function MerchantPortalPamContractControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamContractControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamContractControllerEntity
