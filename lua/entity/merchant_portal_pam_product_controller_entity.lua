-- BluefinTecsMerchantPortal SDK MerchantPortalPamProductController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamProductControllerEntity = {}
MerchantPortalPamProductControllerEntity.__index = MerchantPortalPamProductControllerEntity


function MerchantPortalPamProductControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamProductControllerEntity)
  self._name = "merchant_portal_pam_product_controller"
  self._client = client
...
function MerchantPortalPamProductControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamProductControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamProductControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamProductControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamProductControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamProductControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamProductControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamProductControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamProductControllerEntity:match_get()
...
function MerchantPortalPamProductControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamProductControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamProductController
---@return string? err
function MerchantPortalPamProductControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamProductControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamProductControllerEntity
