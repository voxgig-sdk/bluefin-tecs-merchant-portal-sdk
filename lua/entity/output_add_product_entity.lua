...
local OutputAddProductEntity = {}
OutputAddProductEntity.__index = OutputAddProductEntity


function OutputAddProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputAddProductEntity)
  self._name = "output_add_product"
  self._client = client
...
function OutputAddProductEntity:get_name()
  return self._name
end


function OutputAddProductEntity:make()
  local opts = {}
...
function OutputAddProductEntity:mark_deleted()
  self._deleted = true
end


function OutputAddProductEntity:deleted()
  return true == self._deleted
end


function OutputAddProductEntity:data_set(args)
  if args ~= nil then
...
function OutputAddProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputAddProductEntity:match_set(args)
  if args ~= nil then
...
function OutputAddProductEntity:match_get()
...
function OutputAddProductEntity:stream(action, args, callopts)
...
---@param reqdata OutputAddProductCreateData
---@param ctrl? table
---@return OutputAddProduct
---@return string? err
function OutputAddProductEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputAddProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
