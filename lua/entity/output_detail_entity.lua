...
local OutputDetailEntity = {}
OutputDetailEntity.__index = OutputDetailEntity


function OutputDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputDetailEntity)
  self._name = "output_detail"
  self._client = client
...
function OutputDetailEntity:get_name()
  return self._name
end


function OutputDetailEntity:make()
  local opts = {}
...
function OutputDetailEntity:mark_deleted()
  self._deleted = true
end


function OutputDetailEntity:deleted()
  return true == self._deleted
end


function OutputDetailEntity:data_set(args)
  if args ~= nil then
...
function OutputDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputDetailEntity:match_set(args)
  if args ~= nil then
...
function OutputDetailEntity:match_get()
...
function OutputDetailEntity:stream(action, args, callopts)
...
---@param reqmatch OutputDetailLoadMatch
---@param ctrl? table
---@return OutputDetail
---@return string? err
function OutputDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OutputDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
