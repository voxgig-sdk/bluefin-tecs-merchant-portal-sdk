...
local OutputMoveTidEntity = {}
OutputMoveTidEntity.__index = OutputMoveTidEntity


function OutputMoveTidEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputMoveTidEntity)
  self._name = "output_move_tid"
  self._client = client
...
function OutputMoveTidEntity:get_name()
  return self._name
end


function OutputMoveTidEntity:make()
  local opts = {}
...
function OutputMoveTidEntity:mark_deleted()
  self._deleted = true
end


function OutputMoveTidEntity:deleted()
  return true == self._deleted
end


function OutputMoveTidEntity:data_set(args)
  if args ~= nil then
...
function OutputMoveTidEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputMoveTidEntity:match_set(args)
  if args ~= nil then
...
function OutputMoveTidEntity:match_get()
...
function OutputMoveTidEntity:stream(action, args, callopts)
...
---@param reqdata OutputMoveTidCreateData
---@param ctrl? table
---@return OutputMoveTid
---@return string? err
function OutputMoveTidEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputMoveTidEntity:_run_op(ctx, post_done)
  local utility = self._utility
