...
local OutputCreateProductEntity = {}
OutputCreateProductEntity.__index = OutputCreateProductEntity


function OutputCreateProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputCreateProductEntity)
  self._name = "output_create_product"
  self._client = client
...
function OutputCreateProductEntity:get_name()
  return self._name
end


function OutputCreateProductEntity:make()
  local opts = {}
...
function OutputCreateProductEntity:mark_deleted()
  self._deleted = true
end


function OutputCreateProductEntity:deleted()
  return true == self._deleted
end


function OutputCreateProductEntity:data_set(args)
  if args ~= nil then
...
function OutputCreateProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputCreateProductEntity:match_set(args)
  if args ~= nil then
...
function OutputCreateProductEntity:match_get()
...
function OutputCreateProductEntity:stream(action, args, callopts)
...
---@param reqdata OutputCreateProductCreateData
---@param ctrl? table
---@return OutputCreateProduct
---@return string? err
function OutputCreateProductEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputCreateProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputCreateProductEntity
