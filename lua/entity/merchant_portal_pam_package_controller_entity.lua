-- BluefinTecsMerchantPortal SDK MerchantPortalPamPackageController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamPackageControllerEntity = {}
MerchantPortalPamPackageControllerEntity.__index = MerchantPortalPamPackageControllerEntity


function MerchantPortalPamPackageControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamPackageControllerEntity)
  self._name = "merchant_portal_pam_package_controller"
  self._client = client
...
function MerchantPortalPamPackageControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamPackageControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamPackageControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamPackageControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamPackageControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamPackageControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamPackageControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamPackageControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamPackageControllerEntity:match_get()
...
function MerchantPortalPamPackageControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamPackageControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamPackageController
---@return string? err
function MerchantPortalPamPackageControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamPackageControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamPackageControllerEntity
