...
local MerchantPortalCommonControllerEntity = {}
MerchantPortalCommonControllerEntity.__index = MerchantPortalCommonControllerEntity


function MerchantPortalCommonControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalCommonControllerEntity)
  self._name = "merchant_portal_common_controller"
  self._client = client
...
function MerchantPortalCommonControllerEntity:get_name()
  return self._name
end


function MerchantPortalCommonControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalCommonControllerEntity.new(self._client, opts)
end
...
function MerchantPortalCommonControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalCommonControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalCommonControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalCommonControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalCommonControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalCommonControllerEntity:match_get()
...
function MerchantPortalCommonControllerEntity:stream(action, args, callopts)
...
---@param reqmatch MerchantPortalCommonControllerLoadMatch
---@param ctrl? table
---@return MerchantPortalCommonController
---@return string? err
function MerchantPortalCommonControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MerchantPortalCommonControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalCommonControllerEntity
