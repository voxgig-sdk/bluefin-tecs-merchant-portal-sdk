...
local OutputRemoveProductEntity = {}
OutputRemoveProductEntity.__index = OutputRemoveProductEntity


function OutputRemoveProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputRemoveProductEntity)
  self._name = "output_remove_product"
  self._client = client
...
function OutputRemoveProductEntity:get_name()
  return self._name
end


function OutputRemoveProductEntity:make()
  local opts = {}
...
function OutputRemoveProductEntity:mark_deleted()
  self._deleted = true
end


function OutputRemoveProductEntity:deleted()
  return true == self._deleted
end


function OutputRemoveProductEntity:data_set(args)
  if args ~= nil then
...
function OutputRemoveProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputRemoveProductEntity:match_set(args)
  if args ~= nil then
...
function OutputRemoveProductEntity:match_get()
...
function OutputRemoveProductEntity:stream(action, args, callopts)
...
---@param reqdata OutputRemoveProductCreateData
---@param ctrl? table
---@return OutputRemoveProduct
---@return string? err
function OutputRemoveProductEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputRemoveProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputRemoveProductEntity
