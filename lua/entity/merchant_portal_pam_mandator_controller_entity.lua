-- BluefinTecsMerchantPortal SDK MerchantPortalPamMandatorController entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPortalPamMandatorControllerEntity = {}
MerchantPortalPamMandatorControllerEntity.__index = MerchantPortalPamMandatorControllerEntity


function MerchantPortalPamMandatorControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPortalPamMandatorControllerEntity)
  self._name = "merchant_portal_pam_mandator_controller"
  self._client = client
...
function MerchantPortalPamMandatorControllerEntity:get_name()
  return self._name
end


function MerchantPortalPamMandatorControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPortalPamMandatorControllerEntity.new(self._client, opts)
end
...
function MerchantPortalPamMandatorControllerEntity:mark_deleted()
  self._deleted = true
end


function MerchantPortalPamMandatorControllerEntity:deleted()
  return true == self._deleted
end


function MerchantPortalPamMandatorControllerEntity:data_set(args)
  if args ~= nil then
...
function MerchantPortalPamMandatorControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPortalPamMandatorControllerEntity:match_set(args)
  if args ~= nil then
...
function MerchantPortalPamMandatorControllerEntity:match_get()
...
function MerchantPortalPamMandatorControllerEntity:stream(action, args, callopts)
...
---@param reqdata MerchantPortalPamMandatorControllerCreateData
---@param ctrl? table
---@return MerchantPortalPamMandatorController
---@return string? err
function MerchantPortalPamMandatorControllerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function MerchantPortalPamMandatorControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPortalPamMandatorControllerEntity
