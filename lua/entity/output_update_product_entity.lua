...
local OutputUpdateProductEntity = {}
OutputUpdateProductEntity.__index = OutputUpdateProductEntity


function OutputUpdateProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputUpdateProductEntity)
  self._name = "output_update_product"
  self._client = client
...
function OutputUpdateProductEntity:get_name()
  return self._name
end


function OutputUpdateProductEntity:make()
  local opts = {}
...
function OutputUpdateProductEntity:mark_deleted()
  self._deleted = true
end


function OutputUpdateProductEntity:deleted()
  return true == self._deleted
end


function OutputUpdateProductEntity:data_set(args)
  if args ~= nil then
...
function OutputUpdateProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputUpdateProductEntity:match_set(args)
  if args ~= nil then
...
function OutputUpdateProductEntity:match_get()
...
function OutputUpdateProductEntity:stream(action, args, callopts)
...
---@param reqdata OutputUpdateProductCreateData
---@param ctrl? table
---@return OutputUpdateProduct
---@return string? err
function OutputUpdateProductEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputUpdateProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputUpdateProductEntity
