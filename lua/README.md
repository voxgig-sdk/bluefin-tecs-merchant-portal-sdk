...
| `additional_data` | `table` | Arbitrary merchant-specific data related to terminal registration. |
...
| Field | Type | Description |
| --- | --- | --- |
| `additional_data` | `table` | Optional additional merchant-specific data related to enabling acquiring. |
...
| `terminalIds` | `table` | Optional list of terminal IDs for which acquiring should be activated. |
...
| --- | --- | --- |
| `packageUUID` | `string` | Unique identifier for the package. |
| `productUUIDs` | `table` | The list of unique identifiers of the products. |
...
| --- | --- | --- |
| `packageUUID` | `string` | Unique identifier for the package. |
| `productUUIDs` | `table` | List of product unique identifiers. |
| `responseCode` | `number` | Response code. |
| `responseMessage` | `string` | Response message. |
