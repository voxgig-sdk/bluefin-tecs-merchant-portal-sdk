...
describe("OutputMessageDirect", function()
  it("should direct-load-output_message", function()
    local setup = output_message_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-output_message", setup.live and "live" or "unit")
