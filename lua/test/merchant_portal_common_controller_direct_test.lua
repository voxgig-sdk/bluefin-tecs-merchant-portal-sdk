...
describe("MerchantPortalCommonControllerDirect", function()
  it("should direct-load-merchant_portal_common_controller", function()
    local setup = merchant_portal_common_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-merchant_portal_common_controller", setup.live and "live" or "unit")
