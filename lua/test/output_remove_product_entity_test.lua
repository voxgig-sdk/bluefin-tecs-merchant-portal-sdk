...
describe("OutputRemoveProductEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_REMOVE_PRODUCT_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    output_remove_product_ref01_data = helpers.to_map(type(output_remove_product_ref01_data_result) == 'table' and output_remove_product_ref01_data_result.data_get and output_remove_product_ref01_data_result:data_get() or output_remove_product_ref01_data_result)
...
function output_remove_product_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_REMOVE_PRODUCT_ENTID")
