...
describe("OutputDetailDirect", function()
  it("should direct-load-output_detail", function()
    local setup = output_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-output_detail", setup.live and "live" or "unit")
