...
describe("OutputStatusDirect", function()
  it("should direct-load-output_status", function()
    local setup = output_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-output_status", setup.live and "live" or "unit")
