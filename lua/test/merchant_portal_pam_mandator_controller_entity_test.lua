...
describe("MerchantPortalPamMandatorControllerEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_MANDATOR_CONTROLLER_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    merchant_portal_pam_mandator_controller_ref01_data = helpers.to_map(type(merchant_portal_pam_mandator_controller_ref01_data_result) == 'table' and merchant_portal_pam_mandator_controller_ref01_data_result.data_get and merchant_portal_pam_mandator_controller_ref01_data_result:data_get() or merchant_portal_pam_mandator_controller_ref01_data_result)
...
function merchant_portal_pam_mandator_controller_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_MANDATOR_CONTROLLER_ENTID")
