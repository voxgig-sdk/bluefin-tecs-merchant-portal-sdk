// Behavioural feature-test harness for the BluefinTecsMerchantPortal SDK (C port of the
...
#ifndef BLUEFINTECSMERCHANTPORTAL_FEATURE_HARNESS_H
#define BLUEFINTECSMERCHANTPORTAL_FEATURE_HARNESS_H
...
#endif // BLUEFINTECSMERCHANTPORTAL_FEATURE_HARNESS_H
