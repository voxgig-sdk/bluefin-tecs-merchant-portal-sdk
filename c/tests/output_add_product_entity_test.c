...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_portal_output_add_product(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_portal_output_add_product(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_add_product_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_portal_output_add_product(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_add_product_stream(pe, "list", NULL, NULL, &perr);
