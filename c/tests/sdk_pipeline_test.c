...
int main(void) {
  ...
  BluefinTecsMerchantPortalSDK* t = test_sdk(NULL, NULL);
  ...
  BluefinTecsMerchantPortalSDK* sdk = bluefintecsmerchantportal_sdk_new(opts);
  ...
  BluefinTecsMerchantPortalSDK* rsdk = bluefintecsmerchantportal_sdk_new(ropts);
  PNError* rerr = NULL;
