...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_portal_output_message(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_portal_output_message(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_message_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_portal_output_message(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_message_stream(pe, "list", NULL, NULL, &perr);
