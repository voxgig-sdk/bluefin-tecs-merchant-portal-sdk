...
static BluefinTecsMerchantPortalSDK* C;
static Utility* U;
...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsMerchantPortalSDK* live = bluefintecsmerchantportal_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsMerchantPortalSDK* blocked = bluefintecsmerchantportal_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsMerchantPortalSDK* client = bluefintecsmerchantportal_sdk_new(v_undef());
