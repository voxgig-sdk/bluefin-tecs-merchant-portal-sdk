// Minimal C test harness for the BluefinTecsMerchantPortal SDK test binaries. Each test
...
#ifndef BLUEFINTECSMERCHANTPORTAL_CTEST_H
#define BLUEFINTECSMERCHANTPORTAL_CTEST_H
...
#endif // BLUEFINTECSMERCHANTPORTAL_CTEST_H
