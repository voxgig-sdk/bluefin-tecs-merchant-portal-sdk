...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_portal_output_list(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_portal_output_list(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_list_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_portal_output_list(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_list_stream(pe, "list", NULL, NULL, &perr);
