// Generated direct-call test for the merchant_portal_common_controller entity (mirrors the
...
static voxgig_value* merchant_portal_common_controller_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static BluefinTecsMerchantPortalSDK* merchant_portal_common_controller_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LOAD
  {
    ...
    BluefinTecsMerchantPortalSDK* sdk = merchant_portal_common_controller_direct_setup(mockres);
    voxgig_value* params = v_map();
    PNError* err = NULL;
    voxgig_value* result = sdk_direct(sdk, cmap(3,
      "path", v_str("merchantportalws/logDeveloperInfo"),
      "method", v_str("GET"),
      "params", params), &err);
