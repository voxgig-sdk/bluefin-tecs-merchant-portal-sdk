...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_portal_output_start(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_portal_output_start(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_start_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_portal_output_start(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_start_stream(pe, "list", NULL, NULL, &perr);
