...
int main(void) {
  ...
  Entity* e = bluefin_tecs_merchant_portal_output_status(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_merchant_portal_output_status(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_status_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_merchant_portal_output_status(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_status_stream(pe, "list", NULL, NULL, &perr);
