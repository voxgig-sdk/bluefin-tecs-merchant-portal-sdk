// BluefinTecsMerchantPortal SDK — umbrella runtime header (template; BluefinTecsMerchantPortal tokens
...
#ifndef BLUEFINTECSMERCHANTPORTAL_SDK_H
#define BLUEFINTECSMERCHANTPORTAL_SDK_H
...
typedef struct BluefinTecsMerchantPortalSDK BluefinTecsMerchantPortalSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinTecsMerchantPortalError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinTecsMerchantPortal"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinTecsMerchantPortalEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinTecsMerchantPortalEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinTecsMerchantPortalSDK) — generic fields.
// ===========================================================================

struct BluefinTecsMerchantPortalSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinTecsMerchantPortalSDK* sdk, Feature* f);
void sdk_features_insert(BluefinTecsMerchantPortalSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinTecsMerchantPortalSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinTecsMerchantPortalSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinTecsMerchantPortalSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinTecsMerchantPortalSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinTecsMerchantPortalSDK* bluefintecsmerchantportal_sdk_new(voxgig_value* options);
BluefinTecsMerchantPortalSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinTecsMerchantPortalSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinTecsMerchantPortalSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(BluefinTecsMerchantPortalSDK* sdk, const char* query,
...
#endif // BLUEFINTECSMERCHANTPORTAL_SDK_H
