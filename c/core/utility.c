...
// ---- SDK client-base generic helpers (Main.fragment BluefinTecsMerchantPortalSDK) -------
...
voxgig_value* sdk_options_map(BluefinTecsMerchantPortalSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinTecsMerchantPortalSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinTecsMerchantPortalSDK* sdk) { return sdk->rootctx; }
