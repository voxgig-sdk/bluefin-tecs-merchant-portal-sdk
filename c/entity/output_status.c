// OutputStatus entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_status_entity {
  ...
  bool deleted;
} output_status_entity;

typedef void (*output_status_postdone_fn)(output_status_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT output_status_VT;
static const char* output_status_get_name(Entity* e);
static Entity* output_status_make(Entity* e);
static voxgig_value* output_status_data(Entity* e, voxgig_value* args);
static voxgig_value* output_status_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* output_status_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** output_status_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* output_status_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_status_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_status_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void output_status_mark_deleted(Entity* e);
static bool output_status_deleted(Entity* e);

static Context* output_status_ent_ctx(output_status_entity* self) {
  return self->entctx;
}

Entity* output_status_entity_new(BluefinTecsMerchantPortalSDK* client, voxgig_value* entopts) {
  ...
  output_status_entity* self = (output_status_entity*)calloc(1, sizeof(output_status_entity));
  self->base.vt = &output_status_VT;
  self->name = strdup("output_status");
  self->client = client;
...
static voxgig_value* output_status_run_op(output_status_entity* self, Context* ctx,
                                    output_status_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_status_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  output_status_entity* self = (output_status_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, output_status_ent_ctx(self));
...
static const char* output_status_get_name(Entity* e) {
  return ((output_status_entity*)e)->name;
}
...
static Entity* output_status_make(Entity* e) {
  ...
  return output_status_entity_new(self->client, opts);
}
...
static voxgig_value* output_status_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_status_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_status_ent_ctx(self), "GetData");
...
static voxgig_value* output_status_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_status_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_status_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void output_status_load_postdone(output_status_entity* self, Context* ctx) {
...
static Entity* output_status_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, output_status_ent_ctx(self));
  output_status_run_op(self, ctx, output_status_load_postdone, err);
  if (*err) return NULL;
...
static Entity** output_status_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "output_status");
  return NULL;
}

static Entity* output_status_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "output_status");
  return NULL;
}

static Entity* output_status_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_status");
  return NULL;
}

static Entity* output_status_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "output_status");
  return NULL;
}
...
// live record.
static void output_status_mark_deleted(Entity* e) {
  ((output_status_entity*)e)->deleted = true;
}

static bool output_status_deleted(Entity* e) {
  return ((output_status_entity*)e)->deleted;
}

static const EntityVT output_status_VT = {
  output_status_get_name,
  output_status_make,
  output_status_data,
  output_status_matchv,
  output_status_mark_deleted,
  output_status_deleted,
  output_status_load,
  output_status_list,
  output_status_create,
  output_status_update,
  output_status_remove,
};
