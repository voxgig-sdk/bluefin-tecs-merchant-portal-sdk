// OutputMessage entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_message_entity {
  ...
  bool deleted;
} output_message_entity;

typedef void (*output_message_postdone_fn)(output_message_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT output_message_VT;
static const char* output_message_get_name(Entity* e);
static Entity* output_message_make(Entity* e);
static voxgig_value* output_message_data(Entity* e, voxgig_value* args);
static voxgig_value* output_message_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* output_message_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** output_message_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* output_message_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_message_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_message_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void output_message_mark_deleted(Entity* e);
static bool output_message_deleted(Entity* e);

static Context* output_message_ent_ctx(output_message_entity* self) {
  return self->entctx;
}

Entity* output_message_entity_new(BluefinTecsMerchantPortalSDK* client, voxgig_value* entopts) {
  ...
  output_message_entity* self = (output_message_entity*)calloc(1, sizeof(output_message_entity));
  self->base.vt = &output_message_VT;
  self->name = strdup("output_message");
  self->client = client;
...
static voxgig_value* output_message_run_op(output_message_entity* self, Context* ctx,
                                    output_message_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_message_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  output_message_entity* self = (output_message_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, output_message_ent_ctx(self));
...
static const char* output_message_get_name(Entity* e) {
  return ((output_message_entity*)e)->name;
}
...
static Entity* output_message_make(Entity* e) {
  ...
  return output_message_entity_new(self->client, opts);
}
...
static voxgig_value* output_message_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_message_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_message_ent_ctx(self), "GetData");
...
static voxgig_value* output_message_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_message_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_message_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void output_message_load_postdone(output_message_entity* self, Context* ctx) {
...
static Entity* output_message_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, output_message_ent_ctx(self));
  output_message_run_op(self, ctx, output_message_load_postdone, err);
  if (*err) return NULL;
...
static Entity** output_message_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "output_message");
  return NULL;
}

static Entity* output_message_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "output_message");
  return NULL;
}

static Entity* output_message_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_message");
  return NULL;
}

static Entity* output_message_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "output_message");
  return NULL;
}
...
// live record.
static void output_message_mark_deleted(Entity* e) {
  ((output_message_entity*)e)->deleted = true;
}

static bool output_message_deleted(Entity* e) {
  return ((output_message_entity*)e)->deleted;
}

static const EntityVT output_message_VT = {
  output_message_get_name,
  output_message_make,
  output_message_data,
  output_message_matchv,
  output_message_mark_deleted,
  output_message_deleted,
  output_message_load,
  output_message_list,
  output_message_create,
  output_message_update,
  output_message_remove,
};
