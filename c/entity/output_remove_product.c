// OutputRemoveProduct entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_remove_product_entity {
...
static const char* output_remove_product_get_name(Entity* e);
...
Entity* output_remove_product_entity_new(BluefinTecsMerchantPortalSDK* client, voxgig_value* entopts) {
  ...
  output_remove_product_entity* self = (output_remove_product_entity*)calloc(1, sizeof(output_remove_product_entity));
  self->base.vt = &output_remove_product_VT;
  self->name = strdup("output_remove_product");
  self->client = client;
...
static voxgig_value* output_remove_product_run_op(output_remove_product_entity* self, Context* ctx,
                                    output_remove_product_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_remove_product_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* output_remove_product_get_name(Entity* e) {
  return ((output_remove_product_entity*)e)->name;
}
...
static Entity* output_remove_product_make(Entity* e) {
  ...
  return output_remove_product_entity_new(self->client, opts);
}
...
static voxgig_value* output_remove_product_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_remove_product_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_remove_product_ent_ctx(self), "GetData");
...
static voxgig_value* output_remove_product_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_remove_product_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_remove_product_ent_ctx(self), "GetMatch");
...
static void output_remove_product_create_postdone(output_remove_product_entity* self, Context* ctx) {
...
static const EntityVT output_remove_product_VT = {
  output_remove_product_get_name,
  ...
  output_remove_product_update,
  output_remove_product_remove,
};
