# BluefinTecsMerchantPortal Lean SDK



The Lean SDK for the BluefinTecsMerchantPortal API — an entity-oriented client
...
[Releases](https://github.com/voxgig-sdk/bluefin-tecs-merchant-portal-sdk/releases)) or from a source checkout. The runtime is
...
def main : IO Unit := do
  ...
  (do
    ...
    let result ← Merchant_portal_api_controller.create sdk (← emptyMap) (← emptyMap)
