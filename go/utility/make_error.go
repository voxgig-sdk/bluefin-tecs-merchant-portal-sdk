...
import "github.com/voxgig-sdk/bluefin-tecs-merchant-portal-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.BluefinTecsMerchantPortalError{
	...
	if se, ok := err.(*core.BluefinTecsMerchantPortalError); ok {
		sdkErr.Code = se.Code
	}
