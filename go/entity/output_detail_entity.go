...
type OutputDetailEntity struct {
	name    string
...
func NewOutputDetailEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputDetailEntity) GetName() string { return e.name }
...
func (e *OutputDetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputDetailEntity(e.client, opts)
}

func (e *OutputDetailEntity) Data(args ...any) any {
...
func (e *OutputDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputDetailEntity) DataTyped(data ...OutputDetail) OutputDetail {
	if len(data) > 0 {
		return typedFrom[OutputDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputDetail (all fields
// optional at the wire level).
func (e *OutputDetailEntity) MatchTyped(match ...OutputDetail) OutputDetail {
	if len(match) > 0 {
		return typedFrom[OutputDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputDetail](e.Match())
}
...
func (e *OutputDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputDetailEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputDetailLoadMatch and returns an OutputDetail. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OutputDetailEntity) LoadTyped(reqmatch OutputDetailLoadMatch, ctrl map[string]any) (OutputDetail, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OutputDetail{}, err
	}
	return typedFrom[OutputDetail](res), nil
}



func (e *OutputDetailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OutputDetailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OutputDetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputDetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
