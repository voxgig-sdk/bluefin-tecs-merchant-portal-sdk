...
func NewOutputStartEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputStartEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputStartEntity) GetName() string { return e.name }
...
func (e *OutputStartEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputStartEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputStartEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputStartEntity(e.client, opts)
}

func (e *OutputStartEntity) Data(args ...any) any {
...
func (e *OutputStartEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputStart; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputStartEntity) DataTyped(data ...OutputStart) OutputStart {
	if len(data) > 0 {
		return typedFrom[OutputStart](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputStart](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputStart (all fields
// optional at the wire level).
func (e *OutputStartEntity) MatchTyped(match ...OutputStart) OutputStart {
	if len(match) > 0 {
		return typedFrom[OutputStart](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputStart](e.Match())
}
...
func (e *OutputStartEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputStartEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputStartEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputStartEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputStartCreateData and returns an OutputStart. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputStartEntity) CreateTyped(reqdata OutputStartCreateData, ctrl map[string]any) (OutputStart, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputStart{}, err
	}
	return typedFrom[OutputStart](res), nil
}



func (e *OutputStartEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputStartEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputStartEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
