...
type OutputAddProductEntity struct {
	name    string
...
func NewOutputAddProductEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputAddProductEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputAddProductEntity) GetName() string { return e.name }
...
func (e *OutputAddProductEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputAddProductEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputAddProductEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputAddProductEntity(e.client, opts)
}

func (e *OutputAddProductEntity) Data(args ...any) any {
...
func (e *OutputAddProductEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputAddProduct; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputAddProductEntity) DataTyped(data ...OutputAddProduct) OutputAddProduct {
	if len(data) > 0 {
		return typedFrom[OutputAddProduct](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputAddProduct](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputAddProduct (all fields
// optional at the wire level).
func (e *OutputAddProductEntity) MatchTyped(match ...OutputAddProduct) OutputAddProduct {
	if len(match) > 0 {
		return typedFrom[OutputAddProduct](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputAddProduct](e.Match())
}
...
func (e *OutputAddProductEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputAddProductEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputAddProductEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputAddProductEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputAddProductCreateData and returns an OutputAddProduct. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputAddProductEntity) CreateTyped(reqdata OutputAddProductCreateData, ctrl map[string]any) (OutputAddProduct, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputAddProduct{}, err
	}
	return typedFrom[OutputAddProduct](res), nil
}



func (e *OutputAddProductEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputAddProductEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputAddProductEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
