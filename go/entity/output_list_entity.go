...
func NewOutputListEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputListEntity) GetName() string { return e.name }
...
func (e *OutputListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputListEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputListEntity(e.client, opts)
}

func (e *OutputListEntity) Data(args ...any) any {
...
func (e *OutputListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputListEntity) DataTyped(data ...OutputList) OutputList {
	if len(data) > 0 {
		return typedFrom[OutputList](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputList (all fields
// optional at the wire level).
func (e *OutputListEntity) MatchTyped(match ...OutputList) OutputList {
	if len(match) > 0 {
		return typedFrom[OutputList](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputList](e.Match())
}
...
func (e *OutputListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputListCreateData and returns an OutputList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputListEntity) CreateTyped(reqdata OutputListCreateData, ctrl map[string]any) (OutputList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputList{}, err
	}
	return typedFrom[OutputList](res), nil
}



func (e *OutputListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
