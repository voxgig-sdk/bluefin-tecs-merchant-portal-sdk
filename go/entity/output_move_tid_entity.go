...
type OutputMoveTidEntity struct {
	name    string
...
func NewOutputMoveTidEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputMoveTidEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputMoveTidEntity) GetName() string { return e.name }
...
func (e *OutputMoveTidEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputMoveTidEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputMoveTidEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputMoveTidEntity(e.client, opts)
}

func (e *OutputMoveTidEntity) Data(args ...any) any {
...
func (e *OutputMoveTidEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputMoveTid; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputMoveTidEntity) DataTyped(data ...OutputMoveTid) OutputMoveTid {
	if len(data) > 0 {
		return typedFrom[OutputMoveTid](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputMoveTid](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputMoveTid (all fields
// optional at the wire level).
func (e *OutputMoveTidEntity) MatchTyped(match ...OutputMoveTid) OutputMoveTid {
	if len(match) > 0 {
		return typedFrom[OutputMoveTid](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputMoveTid](e.Match())
}
...
func (e *OutputMoveTidEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputMoveTidEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputMoveTidEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputMoveTidEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputMoveTidCreateData and returns an OutputMoveTid. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputMoveTidEntity) CreateTyped(reqdata OutputMoveTidCreateData, ctrl map[string]any) (OutputMoveTid, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputMoveTid{}, err
	}
	return typedFrom[OutputMoveTid](res), nil
}



func (e *OutputMoveTidEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputMoveTidEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputMoveTidEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
