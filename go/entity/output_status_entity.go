...
type OutputStatusEntity struct {
	name    string
...
func NewOutputStatusEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputStatusEntity) GetName() string { return e.name }
...
func (e *OutputStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputStatusEntity(e.client, opts)
}

func (e *OutputStatusEntity) Data(args ...any) any {
...
func (e *OutputStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputStatusEntity) DataTyped(data ...OutputStatus) OutputStatus {
	if len(data) > 0 {
		return typedFrom[OutputStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputStatus (all fields
// optional at the wire level).
func (e *OutputStatusEntity) MatchTyped(match ...OutputStatus) OutputStatus {
	if len(match) > 0 {
		return typedFrom[OutputStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputStatus](e.Match())
}
...
func (e *OutputStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputStatusLoadMatch and returns an OutputStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OutputStatusEntity) LoadTyped(reqmatch OutputStatusLoadMatch, ctrl map[string]any) (OutputStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OutputStatus{}, err
	}
	return typedFrom[OutputStatus](res), nil
}



func (e *OutputStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OutputStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OutputStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
