...
type OutputMessageEntity struct {
	name    string
...
func NewOutputMessageEntity(client *core.BluefinTecsMerchantPortalSDK, entopts map[string]any) *OutputMessageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputMessageEntity) GetName() string { return e.name }
...
func (e *OutputMessageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputMessageEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputMessageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputMessageEntity(e.client, opts)
}

func (e *OutputMessageEntity) Data(args ...any) any {
...
func (e *OutputMessageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputMessage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputMessageEntity) DataTyped(data ...OutputMessage) OutputMessage {
	if len(data) > 0 {
		return typedFrom[OutputMessage](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputMessage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputMessage (all fields
// optional at the wire level).
func (e *OutputMessageEntity) MatchTyped(match ...OutputMessage) OutputMessage {
	if len(match) > 0 {
		return typedFrom[OutputMessage](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputMessage](e.Match())
}
...
func (e *OutputMessageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputMessageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputMessageLoadMatch and returns an OutputMessage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OutputMessageEntity) LoadTyped(reqmatch OutputMessageLoadMatch, ctrl map[string]any) (OutputMessage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OutputMessage{}, err
	}
	return typedFrom[OutputMessage](res), nil
}



func (e *OutputMessageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OutputMessageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OutputMessageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputMessageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputMessageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
