...
func TestOutputUpdateProductEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		outputUpdateProductRef01Data = core.ToMapAny(entityData(outputUpdateProductRef01DataResult))
...
func output_update_productBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_UPDATE_PRODUCT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_UPDATE_PRODUCT_ENTID"])
