...
const testSeed = `map[string]any{"entity": map[string]any{"merchant_portal_api_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_common_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_contract_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_document_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_form_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_mandator_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_merchant_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_package_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_portal_pam_product_controller": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_add_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_create_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_move_tid": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_remove_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_start": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_update_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
