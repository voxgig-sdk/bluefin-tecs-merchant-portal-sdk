...
class OutputRemoveProductEntityTest {
  ...
  fun basic() {
    ...
    outputRemoveProductRef01Data = Helpers.toMapAny(outputRemoveProductRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputRemoveProductBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTPORTAL_TEST_OUTPUT_REMOVE_PRODUCT_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTPORTAL_TEST_OUTPUT_REMOVE_PRODUCT_ENTID"] = idmap
