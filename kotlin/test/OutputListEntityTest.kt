...
class OutputListEntityTest {
  ...
  fun basic() {
    ...
    outputListRef01Data = Helpers.toMapAny(if (outputListRef01DataResult is SdkEntity) outputListRef01DataResult.data() else outputListRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputListBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_LIST_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_LIST_ENTID"] = idmap
