...
class PrimaryUtilityTest {
  ...
  companion object {
    ...
    private var CLIENT: BluefinTecsMerchantPortalSDK? = null
    ...
    fun run(): OmniResolver.Run {
      var r = RUN
      if (null == r) {
        val client = BluefinTecsMerchantPortalSDK.testSDK()
        CLIENT = client
    ...
    fun client(): BluefinTecsMerchantPortalSDK {
      run()
      return CLIENT!!
    }
  ...
  fun featureHookBasic() {
    val hookClient = BluefinTecsMerchantPortalSDK.testSDK()
  ...
  fun featureInitBasic() {
    val initClient = BluefinTecsMerchantPortalSDK.testSDK()
