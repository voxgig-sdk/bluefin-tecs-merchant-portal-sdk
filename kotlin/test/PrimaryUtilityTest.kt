...
import voxgig.bluefintecsmerchantportalsdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefintecsmerchantportalsdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefintecsmerchantportalsdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefintecsmerchantportalsdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinTecsMerchantPortalSDK = BluefinTecsMerchantPortalSDK.testSDK()

  private fun makeTestCtx(client: BluefinTecsMerchantPortalSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinTecsMerchantPortalSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinTecsMerchantPortalSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinTecsMerchantPortalSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinTecsMerchantPortalSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinTecsMerchantPortalSDK.testSDK(null, setupOpts)
