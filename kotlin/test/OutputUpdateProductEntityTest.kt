...
class OutputUpdateProductEntityTest {
  ...
  fun basic() {
    ...
    outputUpdateProductRef01Data = Helpers.toMapAny(outputUpdateProductRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputUpdateProductBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSMERCHANTPORTAL_TEST_OUTPUT_UPDATE_PRODUCT_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSMERCHANTPORTAL_TEST_OUTPUT_UPDATE_PRODUCT_ENTID"] = idmap
