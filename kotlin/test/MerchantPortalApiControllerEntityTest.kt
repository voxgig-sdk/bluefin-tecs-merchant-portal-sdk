...
class MerchantPortalApiControllerEntityTest {
  ...
  fun basic() {
    ...
    merchantPortalApiControllerRef01Data = Helpers.toMapAny(if (merchantPortalApiControllerRef01DataResult is SdkEntity) merchantPortalApiControllerRef01DataResult.data() else merchantPortalApiControllerRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun merchantPortalApiControllerBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_API_CONTROLLER_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_API_CONTROLLER_ENTID"] = idmap
