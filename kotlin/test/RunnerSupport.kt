...
object RunnerSupport {
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinTecsMerchantPortalSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinTecsMerchantPortalSDK?) {
