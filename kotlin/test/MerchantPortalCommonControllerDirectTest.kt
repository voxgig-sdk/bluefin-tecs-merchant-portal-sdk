...
class MerchantPortalCommonControllerDirectTest {

  @Test
  fun directLoadMerchantPortalCommonController() {
    val setup = directSetup(jm("id", "direct01"))
    val mode = if (setup.live) "live" else "unit"
    val reason = RunnerSupport.skipReason("direct", "direct-load-merchant_portal_common_controller", mode)
