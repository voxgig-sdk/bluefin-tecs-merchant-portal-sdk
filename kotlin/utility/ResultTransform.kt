...
fun resultBasic(ctx: Context): voxgig.bluefintecsmerchantportalsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefintecsmerchantportalsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefintecsmerchantportalsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
