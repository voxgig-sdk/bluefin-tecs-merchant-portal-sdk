...
class MerchantPortalPamMandatorControllerEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("merchant_portal_pam_mandator_controller", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MerchantPortalPamMandatorControllerEntity(this.client, opts)
  }
