...
class MerchantPortalPamContractControllerEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("merchant_portal_pam_contract_controller", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MerchantPortalPamContractControllerEntity(this.client, opts)
  }
