...
class MerchantPortalCommonControllerEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("merchant_portal_common_controller", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MerchantPortalCommonControllerEntity(this.client, opts)
  }
