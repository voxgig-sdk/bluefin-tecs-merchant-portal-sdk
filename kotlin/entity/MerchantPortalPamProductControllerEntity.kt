...
class MerchantPortalPamProductControllerEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("merchant_portal_pam_product_controller", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return MerchantPortalPamProductControllerEntity(this.client, opts)
  }
