...
// BluefinTecsMerchantPortal SDK netsim feature
...
class BluefinTecsMerchantPortalNetsimFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _simulate(BluefinTecsMerchantPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinTecsMerchantPortalContext $ctx, array $applied): void
    {
        $client = $this->client;
