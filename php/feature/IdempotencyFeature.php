...
class BluefinTecsMerchantPortalIdempotencyFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _mutating(BluefinTecsMerchantPortalContext $ctx): bool
    {
