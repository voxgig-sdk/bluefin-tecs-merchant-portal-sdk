...
// BluefinTecsMerchantPortal SDK rbac feature
...
class BluefinTecsMerchantPortalRbacFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _required(BluefinTecsMerchantPortalContext $ctx): ?string
    {
    ...
    private function _reject(BluefinTecsMerchantPortalContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinTecsMerchantPortalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
