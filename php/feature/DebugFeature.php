...
class BluefinTecsMerchantPortalDebugFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _finish(BluefinTecsMerchantPortalContext $ctx, bool $ok): void
    {
