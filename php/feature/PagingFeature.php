...
class BluefinTecsMerchantPortalPagingFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _graphql_pre_request(BluefinTecsMerchantPortalContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BluefinTecsMerchantPortalContext $ctx): bool
    {
