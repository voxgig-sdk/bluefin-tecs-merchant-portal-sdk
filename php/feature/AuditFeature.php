...
class BluefinTecsMerchantPortalAuditFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    private function _emit(BluefinTecsMerchantPortalContext $ctx, string $outcome): void
    {
