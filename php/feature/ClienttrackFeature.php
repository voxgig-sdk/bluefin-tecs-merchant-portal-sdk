...
class BluefinTecsMerchantPortalClienttrackFeature extends BluefinTecsMerchantPortalBaseFeature
{
    ...
    public function PostConstruct(BluefinTecsMerchantPortalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinTecsMerchantPortal-SDK';
