...
class BluefinTecsMerchantPortalGraphql
{
    ...
    // equivalent.
    public static function body(BluefinTecsMerchantPortalContext $ctx): mixed
    {
    ...
    public static function errors(BluefinTecsMerchantPortalContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
