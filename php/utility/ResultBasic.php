...
// BluefinTecsMerchantPortal SDK utility: result_basic

class BluefinTecsMerchantPortalResultBasic
{
    public static function call(BluefinTecsMerchantPortalContext $ctx): ?BluefinTecsMerchantPortalResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BluefinTecsMerchantPortalError) ? $result->err->msg : (string)$result->err;
