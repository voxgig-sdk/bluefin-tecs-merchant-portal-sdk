...
class OutputStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputStatusEntity($this->_client, $opts);
    }

    /**
     * @param OutputStatus|array $args OutputStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputStatus|array The current OutputStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputStatus fields).
     */
     ...
     *
     * @param OutputStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OutputStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputStatus|array The loaded OutputStatus as an assoc-array at the
