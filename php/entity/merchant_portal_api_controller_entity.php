...
class MerchantPortalApiControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_api_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalApiControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalApiController|array $args MerchantPortalApiController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalApiController|array The current MerchantPortalApiController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalApiController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalApiController fields).
     */
     ...
     *
     * @param MerchantPortalApiControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalApiControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalApiController|array The created MerchantPortalApiController as an assoc-array at the
