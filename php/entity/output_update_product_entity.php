...
class OutputUpdateProductEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_update_product";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputUpdateProductEntity($this->_client, $opts);
    }

    /**
     * @param OutputUpdateProduct|array $args OutputUpdateProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputUpdateProduct|array The current OutputUpdateProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputUpdateProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputUpdateProduct fields).
     */
     ...
     *
     * @param OutputUpdateProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputUpdateProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputUpdateProduct|array The created OutputUpdateProduct as an assoc-array at the
