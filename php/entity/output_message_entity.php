...
class OutputMessageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputMessageEntity($this->_client, $opts);
    }

    /**
     * @param OutputMessage|array $args OutputMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputMessage|array The current OutputMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputMessage fields).
     */
     ...
     *
     * @param OutputMessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OutputMessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputMessage|array The loaded OutputMessage as an assoc-array at the
