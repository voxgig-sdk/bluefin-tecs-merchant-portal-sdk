...
class OutputCreateProductEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_create_product";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputCreateProductEntity($this->_client, $opts);
    }

    /**
     * @param OutputCreateProduct|array $args OutputCreateProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputCreateProduct|array The current OutputCreateProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputCreateProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputCreateProduct fields).
     */
     ...
     *
     * @param OutputCreateProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputCreateProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputCreateProduct|array The created OutputCreateProduct as an assoc-array at the
