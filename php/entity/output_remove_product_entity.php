...
class OutputRemoveProductEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_remove_product";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputRemoveProductEntity($this->_client, $opts);
    }

    /**
     * @param OutputRemoveProduct|array $args OutputRemoveProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputRemoveProduct|array The current OutputRemoveProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputRemoveProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputRemoveProduct fields).
     */
     ...
     *
     * @param OutputRemoveProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputRemoveProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputRemoveProduct|array The created OutputRemoveProduct as an assoc-array at the
