...
class OutputAddProductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputAddProductEntity($this->_client, $opts);
    }

    /**
     * @param OutputAddProduct|array $args OutputAddProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputAddProduct|array The current OutputAddProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputAddProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputAddProduct fields).
     */
     ...
     *
     * @param OutputAddProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputAddProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputAddProduct|array The created OutputAddProduct as an assoc-array at the
