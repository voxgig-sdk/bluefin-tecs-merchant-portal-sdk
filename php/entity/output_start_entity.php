...
class OutputStartEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputStartEntity($this->_client, $opts);
    }

    /**
     * @param OutputStart|array $args OutputStart data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputStart|array The current OutputStart data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputStart fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputStart fields).
     */
     ...
     *
     * @param OutputStartCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputStartCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputStart|array The created OutputStart as an assoc-array at the
