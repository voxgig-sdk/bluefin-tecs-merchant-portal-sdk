...
class MerchantPortalPamFormControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_form_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamFormControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamFormController|array $args MerchantPortalPamFormController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalPamFormController|array The current MerchantPortalPamFormController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamFormController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalPamFormController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamFormController.
     *
     * @param MerchantPortalPamFormControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamFormControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamFormController|array The created MerchantPortalPamFormController as an assoc-array at the
