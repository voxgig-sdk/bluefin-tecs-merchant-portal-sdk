...
class OutputMoveTidEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputMoveTidEntity($this->_client, $opts);
    }

    /**
     * @param OutputMoveTid|array $args OutputMoveTid data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputMoveTid|array The current OutputMoveTid data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputMoveTid fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputMoveTid fields).
     */
     ...
     *
     * @param OutputMoveTidCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputMoveTidCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputMoveTid|array The created OutputMoveTid as an assoc-array at the
