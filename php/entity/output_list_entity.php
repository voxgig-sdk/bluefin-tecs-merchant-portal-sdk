...
class OutputListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputListEntity($this->_client, $opts);
    }

    /**
     * @param OutputList|array $args OutputList data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputList|array The current OutputList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputList fields).
     */
     ...
     *
     * @param OutputListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputList|array The created OutputList as an assoc-array at the
