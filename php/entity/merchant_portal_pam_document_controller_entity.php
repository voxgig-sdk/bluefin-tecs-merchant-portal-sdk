...
class MerchantPortalPamDocumentControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_document_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamDocumentControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamDocumentController|array $args MerchantPortalPamDocumentController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalPamDocumentController|array The current MerchantPortalPamDocumentController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamDocumentController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalPamDocumentController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamDocumentController.
     *
     * @param MerchantPortalPamDocumentControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamDocumentControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamDocumentController|array The created MerchantPortalPamDocumentController as an assoc-array at the
