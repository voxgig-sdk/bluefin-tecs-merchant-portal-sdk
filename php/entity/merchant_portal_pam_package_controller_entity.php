...
class MerchantPortalPamPackageControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_package_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamPackageControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamPackageController|array $args MerchantPortalPamPackageController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalPamPackageController|array The current MerchantPortalPamPackageController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamPackageController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalPamPackageController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamPackageController.
     *
     * @param MerchantPortalPamPackageControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamPackageControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamPackageController|array The created MerchantPortalPamPackageController as an assoc-array at the
