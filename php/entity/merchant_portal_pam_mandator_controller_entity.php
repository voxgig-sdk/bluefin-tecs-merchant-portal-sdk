...
class MerchantPortalPamMandatorControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_mandator_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamMandatorControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamMandatorController|array $args MerchantPortalPamMandatorController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalPamMandatorController|array The current MerchantPortalPamMandatorController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamMandatorController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalPamMandatorController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamMandatorController.
     *
     * @param MerchantPortalPamMandatorControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamMandatorControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamMandatorController|array The created MerchantPortalPamMandatorController as an assoc-array at the
