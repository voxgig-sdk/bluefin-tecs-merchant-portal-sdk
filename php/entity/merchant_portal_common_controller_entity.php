...
// BluefinTecsMerchantPortal SDK MerchantPortalCommonController entity
...
class MerchantPortalCommonControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_common_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalCommonControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalCommonController|array $args MerchantPortalCommonController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalCommonController|array The current MerchantPortalCommonController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalCommonController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalCommonController fields).
     */
    ...
    /**
     * Load a single MerchantPortalCommonController.
     *
     * @param MerchantPortalCommonControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MerchantPortalCommonControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalCommonController|array The loaded MerchantPortalCommonController as an assoc-array at the
