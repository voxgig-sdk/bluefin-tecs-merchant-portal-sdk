...
class MerchantPortalPamProductControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_product_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamProductControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamProductController|array $args MerchantPortalPamProductController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalPamProductController|array The current MerchantPortalPamProductController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamProductController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalPamProductController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamProductController.
     *
     * @param MerchantPortalPamProductControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamProductControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamProductController|array The created MerchantPortalPamProductController as an assoc-array at the
