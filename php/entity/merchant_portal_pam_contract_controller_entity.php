...
class MerchantPortalPamContractControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_contract_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamContractControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamContractController|array $args MerchantPortalPamContractController data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = BluefinTecsMerchantPortalHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return MerchantPortalPamContractController|array The current MerchantPortalPamContractController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamContractController fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = BluefinTecsMerchantPortalHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of MerchantPortalPamContractController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamContractController.
     *
     * @param MerchantPortalPamContractControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamContractControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamContractController|array The created MerchantPortalPamContractController as an assoc-array at the
     *   SDK boundary; throws BluefinTecsMerchantPortalError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                if ($ctx->result->resdata) {
                    $this->_data = BluefinTecsMerchantPortalHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
