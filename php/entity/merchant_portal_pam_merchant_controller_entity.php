...
class MerchantPortalPamMerchantControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_portal_pam_merchant_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPortalPamMerchantControllerEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPortalPamMerchantController|array $args MerchantPortalPamMerchantController data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPortalPamMerchantController|array The current MerchantPortalPamMerchantController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPortalPamMerchantController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPortalPamMerchantController fields).
     */
    ...
    /**
     * Create a new MerchantPortalPamMerchantController.
     *
     * @param MerchantPortalPamMerchantControllerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPortalPamMerchantControllerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPortalPamMerchantController|array The created MerchantPortalPamMerchantController as an assoc-array at the
