...
class OutputDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputDetailEntity($this->_client, $opts);
    }

    /**
     * @param OutputDetail|array $args OutputDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputDetail|array The current OutputDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputDetail fields).
     */
     ...
     *
     * @param OutputDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OutputDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputDetail|array The loaded OutputDetail as an assoc-array at the
