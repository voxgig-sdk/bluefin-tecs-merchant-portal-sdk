...
// BluefinTecsMerchantPortal SDK feature test
//
...
class FtCtrl extends BluefinTecsMerchantPortalControl
{
...
class FtClient
{
    ...
    private BluefinTecsMerchantPortalUtility $utility;

    public function __construct(BluefinTecsMerchantPortalUtility $utility, array $options)
    {
    ...
    public function get_utility(): BluefinTecsMerchantPortalUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (BluefinTecsMerchantPortalContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public BluefinTecsMerchantPortalContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (BluefinTecsMerchantPortalContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = BluefinTecsMerchantPortalConfig::make_feature($name);
    ...
    private static function buildUrl(BluefinTecsMerchantPortalSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof BluefinTecsMerchantPortalError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new BluefinTecsMerchantPortalResponse($fetched);
        }
    ...
    private function fail(BluefinTecsMerchantPortalContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (BluefinTecsMerchantPortalContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
