...
// BluefinTecsMerchantPortal SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BluefinTecsMerchantPortalSDK::test)
...
{
    private const SDK_CLASS = 'BluefinTecsMerchantPortalSDK';
    ...
    private const SDK_BASE = 'bluefintecsmerchantportal_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefintecsmerchantportal_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
