...
// BluefinTecsMerchantPortal SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BluefinTecsMerchantPortalOmni::makeStructRunner(
    ...
    {
        return BluefinTecsMerchantPortalOmni::objmodel(BluefinTecsMerchantPortalOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BluefinTecsMerchantPortalOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BluefinTecsMerchantPortalOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BluefinTecsMerchantPortalOmni::structfix($now, Struct::undef()))
                        !== json_encode(BluefinTecsMerchantPortalOmni::structfix($val, Struct::undef()))) {
