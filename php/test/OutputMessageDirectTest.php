...
class OutputMessageDirectTest extends TestCase
{
    public function test_direct_load_output_message(): void
    {
        $setup = output_message_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-output_message", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function output_message_direct_setup($mockres)
{
