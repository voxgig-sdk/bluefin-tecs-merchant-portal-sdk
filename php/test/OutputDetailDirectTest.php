...
class OutputDetailDirectTest extends TestCase
{
    public function test_direct_load_output_detail(): void
    {
        $setup = output_detail_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-output_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function output_detail_direct_setup($mockres)
{
