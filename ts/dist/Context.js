...
const BluefinTecsMerchantPortalError_1 = require("./BluefinTecsMerchantPortalError");
...
class Context {
    ...
    error(code, msg) {
        return new BluefinTecsMerchantPortalError_1.BluefinTecsMerchantPortalError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
