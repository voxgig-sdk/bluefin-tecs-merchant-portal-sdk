...
const __1 = require("..");
const SDK_NAME = 'BluefinTecsMerchantPortalSDK';
...
const TEST_SEED = { "entity": { "merchant_portal_api_controller": { "test01": { "id": "test01" } }, "merchant_portal_common_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_contract_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_document_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_form_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_mandator_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_merchant_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_package_controller": { "test01": { "id": "test01" } }, "merchant_portal_pam_product_controller": { "test01": { "id": "test01" } }, "output_add_product": { "test01": { "id": "test01" } }, "output_create_product": { "test01": { "id": "test01" } }, "output_detail": { "test01": { "id": "test01" } }, "output_list": { "test01": { "id": "test01" } }, "output_message": { "test01": { "id": "test01" } }, "output_move_tid": { "test01": { "id": "test01" } }, "output_remove_product": { "test01": { "id": "test01" } }, "output_start": { "test01": { "id": "test01" } }, "output_status": { "test01": { "id": "test01" } }, "output_update_product": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+BluefinTecsMerchantPortalSDK\b/.test(code) ||
        /\bBluefinTecsMerchantPortalSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+BluefinTecsMerchantPortalSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/BluefinTecsMerchantPortalSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
