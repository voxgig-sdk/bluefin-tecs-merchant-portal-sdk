...
(0, node_test_1.describe)('OutputStatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_status.' + op, live))
                return;
        }
        ...
        let output_status_ref01_data = Object.values(setup.data.existing.output_status)[0];
        // LOAD
        const output_status_ref01_ent = client.OutputStatus();
        const output_status_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(output_status_ref01_data_dt0.id === output_status_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_status/OutputStatusTestData.json');
    ...
    let idmap = transform(['output_status01', 'output_status02', 'output_status03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_STATUS_ENTID'];
...
//# sourceMappingURL=OutputStatusEntity.test.js.map