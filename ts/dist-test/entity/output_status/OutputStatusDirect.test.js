...
(0, node_test_1.describe)('OutputStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BluefinTecsMerchantPortalSDK({
    ...
    (0, node_test_1.test)('direct-load-output_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-output_status', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BLUEFIN_TECS_MERCHANT_PORTAL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BluefinTecsMerchantPortalSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_STATUS_ENTID'];
    ...
    const client = new __1.BluefinTecsMerchantPortalSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OutputStatusDirect.test.js.map