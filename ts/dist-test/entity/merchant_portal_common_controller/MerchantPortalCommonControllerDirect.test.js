...
(0, node_test_1.describe)('MerchantPortalCommonControllerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-merchant_portal_common_controller', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-merchant_portal_common_controller', setup.live))
            return;
...
//# sourceMappingURL=MerchantPortalCommonControllerDirect.test.js.map