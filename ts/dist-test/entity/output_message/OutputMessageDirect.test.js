...
(0, node_test_1.describe)('OutputMessageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-output_message', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-output_message', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_MESSAGE_ENTID'];
...
//# sourceMappingURL=OutputMessageDirect.test.js.map