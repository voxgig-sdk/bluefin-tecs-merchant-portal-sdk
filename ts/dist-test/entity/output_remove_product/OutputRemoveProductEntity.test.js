...
(0, node_test_1.describe)('OutputRemoveProductEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_remove_product.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != output_remove_product_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_remove_product/OutputRemoveProductTestData.json');
    ...
    let idmap = transform(['output_remove_product01', 'output_remove_product02', 'output_remove_product03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_REMOVE_PRODUCT_ENTID'];
...
//# sourceMappingURL=OutputRemoveProductEntity.test.js.map