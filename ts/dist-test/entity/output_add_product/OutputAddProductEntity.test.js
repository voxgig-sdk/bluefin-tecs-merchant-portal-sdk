...
(0, node_test_1.describe)('OutputAddProductEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != output_add_product_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_add_product/OutputAddProductTestData.json');
    ...
    let idmap = transform(['output_add_product01', 'output_add_product02', 'output_add_product03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OutputAddProductEntity.test.js.map