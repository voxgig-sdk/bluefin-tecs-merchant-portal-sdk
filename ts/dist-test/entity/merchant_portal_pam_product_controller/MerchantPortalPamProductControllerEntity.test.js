...
(0, node_test_1.describe)('MerchantPortalPamProductControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'merchant_portal_pam_product_controller.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != merchant_portal_pam_product_controller_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/merchant_portal_pam_product_controller/MerchantPortalPamProductControllerTestData.json');
    ...
    let idmap = transform(['merchant_portal_pam_product_controller01', 'merchant_portal_pam_product_controller02', 'merchant_portal_pam_product_controller03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_MERCHANT_PORTAL_PAM_PRODUCT_CONTROLLER_ENTID'];
...
//# sourceMappingURL=MerchantPortalPamProductControllerEntity.test.js.map