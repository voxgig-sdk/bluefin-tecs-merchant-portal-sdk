...
(0, node_test_1.describe)('OutputStartEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_start.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != output_start_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_start/OutputStartTestData.json');
    ...
    let idmap = transform(['output_start01', 'output_start02', 'output_start03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_MERCHANT_PORTAL_TEST_OUTPUT_START_ENTID'];
...
//# sourceMappingURL=OutputStartEntity.test.js.map