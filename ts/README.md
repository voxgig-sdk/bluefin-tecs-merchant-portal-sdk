...
| `additional_data` | `Record<string, any>` | Arbitrary merchant-specific data related to terminal registration. |
...
| Field | Type | Description |
| --- | --- | --- |
| `additional_data` | `Record<string, any>` | Optional additional merchant-specific data related to enabling acquiring. |
